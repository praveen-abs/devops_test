...
class VmtProfilePagesService
{
    ...
    */
    ...
    public function getEmployeeProfileDetails(int $user_id)
    {
        ...
        if (empty($response['getEmployeeDetails']['current_address_line_1'])) {
            $response['getEmployeeDetails']['current_address_line_1'] = '';
        }

        if (empty($response['getEmployeeDetails']['permanent_address_line_1'])) {
            $response['getEmployeeDetails']['permanent_address_line_1'] = '';
        }
