...
class EmployeeBasicCtcExport implements FromArray, ShouldAutoSize, WithHeadings, WithStyles, WithDrawings, WithCustomStartCell,WithTitle
{
   ...
   protected $period;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        //for fourth row
        $sheet->mergeCells('C4:D4')->setCellValue('C4', "Category : ".'All,'.'Active,'.'Resigned,'. 'Yet to activate,'. 'Draft');
        ...
        $sheet->getStyle('A5:' . $this->last_header_column . '5')->getFont()->setBold(true)
            ->getColor()->setRGB('ffffff');
             //last row 
             $sheet->mergeCells('A'.$this->last_row.':G'.$this->last_row)->setCellValue('A'.$this->last_row, " This report is generated by ABShrms Payroll Software : ".$this->date);
