...
class EmployeeBasicCtcExport implements FromArray, ShouldAutoSize, WithHeadings, WithStyles, WithDrawings, WithCustomStartCell, WithTitle
{
    protected $data;
    protected $headers;
    ...
    protected $period;
    public function __construct($type, $data, $headers, $client_name, $public_client_logo_path, $date, $period, $active_status)
    {
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        //For Third Row
        $sheet->mergeCells('C3:D3')->setCellValue('C3', "Period : " . Carbon::parse($this->date)->format('d-M-Y'));
        $sheet->getStyle('C3:D3')->getFont()->setBold(true);
        //for fourth row
        $sheet->mergeCells('C4:D4')->setCellValue('C4', "Category : " . $this->category);
