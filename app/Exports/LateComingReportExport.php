...
class LateComingReportExport implements FromArray,WithStrictNullComparison,WithHeadings,ShouldAutoSize,WithDrawings,WithCustomStartCell,WithStyles
{
    /**
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        //For Second Row
        $sheet->mergeCells('C2:E2')->setCellValue('C2', "Report Type : " .' LateComing Report');
