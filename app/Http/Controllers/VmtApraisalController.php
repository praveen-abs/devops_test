...
class VmtApraisalController extends Controller
{
    ...
    //         $j = 0;
    //         $totRows  = count($importData_arr);
    //         $kpiRows = [];
    //         dd($importData_arr);exit;
    ...
    //                 $kpiRow->dimension   =    $importData[1]; 
    //                 $kpiRow->kpi         =    $importData[2]; 
    //                 $kpiRow->operational_definition   = $importData[3] ;     
    //                 $kpiRow->measure     =    $importData[4];  
    //                 $kpiRow->frequency   =    $importData[5];  
    //                 $kpiRow->target      =    $importData[6];  
    //                 $kpiRow->stretch_target  =    $importData[7];   
    //                 $kpiRow->source          =    $importData[8];  
    //                 $kpiRow->kpi_weightage   =    $importData[9];  
    ...
    {
        $valid_extension = array("csv", "xls"); //Only want csv and excel files
