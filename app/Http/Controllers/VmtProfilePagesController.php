...
class VmtProfilePagesController extends Controller
{
  ...
  /**
    ...
    public function showProfile(Request $request){
        ...
        return view('pages-profile-new', compact('user','allEmployees', 'maritalStatus','genderArray','user_full_details', 'familydetails','emergencyContactDetails','bank', 'exp', 'reportingManager','profileCompletenessValue'));
    }
