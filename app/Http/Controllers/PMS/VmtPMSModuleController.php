                ...
                foreach($assigneeIdsAll as $assignee){
                    ...
                    if($request->flowCheck == 1 || $request->flowCheck == 2){
                        ...
                        if(!empty($assigneeMailId)){
                            ...
                            \Mail::to($assigneeMailId)->send(new VmtPMSMail_PublishForm("none", $assigneeName,$request->hidden_calendar_year,strtoupper($request->assignment_period_start),$assignerName,$command_emp,$request->flowCheck,request()->getSchemeAndHttpHost()));
