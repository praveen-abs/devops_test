...
<<<<<<<< HEAD:bootstrap/ssr/LeaveApply-94239469.mjs
import { S as Service } from "./Service-c5131e0f.mjs";
========
import { S as Service } from "./Service83237.js";
>>>>>>>> 8d26c8e22c787070ff33a545539ffedf1abdf373:bootstrap/ssr/LeaveApply83237.js
inject("$swal");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Button, {
        label: "Apply Leave",
        class: "px-2 py-2 border-0 outline-none font-medium text-[2px] bg-black",
