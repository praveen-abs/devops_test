...
<<<<<<< HEAD:bootstrap/ssr/attendanceLatecomingReports.mjs
...
>>>>>>> 8d26c8e22c787070ff33a545539ffedf1abdf373:bootstrap/ssr/attendanceLatecomingReports83237.js
import "axios";
const attendanceLatecomingReports_vue_vue_type_style_index_0_lang = "";
const _sfc_main = {
  __name: "attendanceLatecomingReports",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><p class="font-semibold text-lg">Attendance Late Coming Reports</p></div><div class="bg-white p-2 my-2 rounded-lg grid grid-cols-12"><div class="grid grid-cols-12 gap-6 col-span-6"><div class="col-span-4"><p>Start date</p>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/hrms/modules/reports/attendance/attendanceLatecomingReports/attendanceLatecomingReports.vue");
...
app.mount("#AttendanceLateComingReports");
