/* empty css            *//* empty css                   *//* empty css                 *//* empty css               */import { ref, reactive, resolveComponent, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, useSSRContext, createApp } from "vue";
...
<<<<<<< HEAD:bootstrap/ssr/AttendanceReport_Detailed.mjs
import { _ as _imports_0 } from "./assets/printer-25261c63.mjs";
import { _ as _imports_1 } from "./assets/download-e687b9d5.mjs";
=======
import { _ as _imports_0 } from "./printer832372.js";
import { _ as _imports_1 } from "./download83237.js";
>>>>>>> 8d26c8e22c787070ff33a545539ffedf1abdf373:bootstrap/ssr/AttendanceReport_Detailed83237.js
import "axios";
import { FilterMatchMode } from "primevue/api";
import "moment";
import "dayjs";
const AttendanceReport_Detailed_vue_vue_type_style_index_0_lang = "";
const _sfc_main = {
  __name: "AttendanceReport_Detailed",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><p class="font-semibold text-lg">Attendance Detail Reports</p></div><div class="bg-white p-2 my-2 rounded-lg grid grid-cols-12"><div class="grid grid-cols-12 gap-6 col-span-6"><div class="col-span-4"><p>Start date</p>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/hrms/modules/reports/attendance/attendanceDetailReports/AttendanceReport_Detailed.vue");
