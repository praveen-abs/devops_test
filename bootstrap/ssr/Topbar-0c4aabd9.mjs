...
<<<<<<<< HEAD:bootstrap/ssr/Topbar-0c4aabd9.mjs
import { u as useMainDashboardStore } from "./dashboard_service-f7b0d880.mjs";
...
========
import { u as useMainDashboardStore } from "./dashboard_service83237.js";
import { S as Service } from "./Service83237.js";
const _imports_0 = "/build/setting83237.svg";
const _imports_1 = "/build/notification83237.svg";
const _imports_2 = "/build/exit83237.svg";
>>>>>>>> 8d26c8e22c787070ff33a545539ffedf1abdf373:bootstrap/ssr/Topbar832372.js
...
<<<<<<<< HEAD:bootstrap/ssr/Topbar-0c4aabd9.mjs
        _push(`<div class="bg-white h-[60px]"><div class="grid items-center justify-between grid-cols-12"><div class="relative border-1 border-x-gray-300 py-2 mx-2 px-2 col-span-4"><button class="text-black rounded focus:outline-none"><p class="text-md text-gray-600 text-left">Your organization</p>`);
========
...
<<<<<<<< HEAD:bootstrap/ssr/Topbar-0c4aabd9.mjs
              _push(`<div class="transition transform cursor-pointer hover:bg-gray-100 hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none"><div class="flex items-center justify-between p-2 hover:bg-gray-200"><div class="cursor-pointer flex mx-2 align-center justify-between rounded-lg p-0.5"><div class="mx-2 p-1 flex items-center justify-between rounded border gap-4" style="${ssrRenderStyle({ "height": "30px", "width": "30px" })}"><img${ssrRenderAttr("src", client.client_logo)} alt="" class="mh-100 mw-100">`);
========
