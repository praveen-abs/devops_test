/* empty css            *//* empty css                   *//* empty css                 */import { reactive, ref, onMounted, resolveComponent, withCtx, createVNode, openBlock, createBlock, Fragment, renderList, useSSRContext, createApp } from "vue";
...
<<<<<<<< HEAD:bootstrap/ssr/HalfDayAbsentReport46681.js
import { _ as _imports_0 } from "./printer46681.js";
import { _ as _imports_1 } from "./download46681.js";
========
import { _ as _imports_0 } from "./printer92532.js";
import { _ as _imports_1 } from "./download92532.js";
>>>>>>>> 3d11572c6ee7fb534efc658b88a39b370fca8e71:bootstrap/ssr/HalfDayAbsentReport92532.js
import "axios";
const HalfDayAbsentReport_vue_vue_type_style_index_0_lang = "";
const _sfc_main = {
  __name: "HalfDayAbsentReport",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div><p class="font-semibold text-lg">Attendance Half Day Absent Reports</p></div><div class="bg-white p-2 my-2 rounded-lg grid grid-cols-12"><div class="grid grid-cols-12 gap-6 col-span-6"><div class="col-span-4"><p>Start date</p>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/hrms/modules/reports/attendance/HalfDayAbsentReport/HalfDayAbsentReport.vue");
