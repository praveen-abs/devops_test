import { resolveComponent, mergeProps, unref, useSSRContext, ref, computed, resolveDirective, withCtx, withDirectives, openBlock, createBlock, createVNode, toDisplayString, createTextVNode, createCommentVNode, vModelText, onMounted, vModelRadio } from "vue";
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrGetDirectiveProps, ssrIncludeBooleanAttr, ssrRenderStyle, ssrRenderAttr, ssrRenderClass, ssrLooseEqual } from "vue/server-renderer";
import { i as investmentMainStore } from "./investmentMainStore-4fa751b4.mjs";
import useValidate from "@vuelidate/core";
import { helpers, required } from "@vuelidate/validators";
import moment from "moment";
import { p as profilePagesStore } from "./ProfilePagesStore-0af90bc0.mjs";
import "axios";
import "./LoadingSpinner-13fb7de2.mjs";
import { S as Service } from "./Service-c5131e0f.mjs";
import "dayjs";
const tax_saving_investments_vue_vue_type_style_index_0_lang = "";
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mb-3 tw-card" }, _attrs))}><div class="flex items-center justify-between mb-3"><h6 class="text-2xl font-semibold">Tax Saving Investment </h6>`);
      _push(ssrRenderComponent(_component_Dropdown, {
        optionLabel: "name",
        placeholder: "Apr 2025 - Mar 2026",
        class: "!bg-[#0873CD] w-[240px] md:w-14rem"
      }, null, _parent));
      _push(`</div><div class="my-6 mx-4 widget-card"><div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4 lg:grid-cols-4"><div class="p-2 text-center border-[1px] rounded-lg tw-card bg-[#F6F6F6] border-[#DDDD]"><p class="mb-2 font-semibold text-[14px] font-[&#39;Poppins&#39;]">Declared Amount </p><h6 class="text-lg font-bold text-[#000]">${ssrInterpolate(unref(investmentStore).formatCurrency(unref(investmentStore).taxSavingInvestments.declared_amt))}</h6></div><div class="p-2 text-center border-[1px] rounded-lg tw-card font-[&#39;Poppins&#39;] bg-[#F6F6F6] border-[#DDDD]"><p class="mb-2 font-semibol text-[14px] font-[&#39;Poppins&#39;] text-[#000]">Approved Amount</p><h6 class="text-lg font-bold text-[#000]">INR ${ssrInterpolate(unref(investmentStore).formatCurrency(unref(investmentStore).taxSavingInvestments.max_limit))}</h6></div><div class="p-2 text-center border-[1px] rounded-lg tw-card bg-[#F6F6F6] border-[#DDDD]"><p class="mb-2 font-[&#39;Poppins&#39;] text-[#000] text-[14px]">Status</p>`);
      if (unref(investmentStore).isSubmitted == 0) {
        _push(`<h6 class="text-lg font-bold text-[#000]">Submitted</h6>`);
      } else if (unref(investmentStore).isSubmitted == 1) {
        _push(`<h6 class="text-lg font-bold text-[#000]">Drafted</h6>`);
      } else {
        _push(`<h6 class="text-lg font-bold">${ssrInterpolate(unref(investmentStore).taxSavingInvestments.status)}</h6>`);
      }
      _push(`</div><div class="p-2 text-center border-[1px] rounded-lg tw-card bg-[#F6F6F6] border-[#DDDD]"><p class="mb-2 font-[&#39;Poppins&#39;] text-[#000] text-[14px]">Late Date For Submission</p><h6 class="text-lg font-bold text-[#000]">${ssrInterpolate(new Date().toLocaleString("default", { month: "long" }))} 27, ${ssrInterpolate(new Date().getFullYear())}</h6></div></div></div></div>`);
    };
  }
};
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
              ...
              body: withCtx((slotProps, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (slotProps.data.json_popups_value) {
                    ...
                    _push3(`<div${_scopeId2}><button class="px-4 py-2 text-center text-white bg-black rounded-md me-4"${ssrIncludeBooleanAttr(!unref(investmentStore).isSubmitted) ? " disabled" : ""}${_scopeId2}><i class="fa fa-plus-circle me-2" aria-hidden="true"${_scopeId2}></i> Add Rented</button></div>`);
                  }
                } else {
                  return [
                    slotProps.data.json_popups_value ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("button", {
                        class: "px-4 py-2 text-center text-white bg-black rounded-md me-4",
      ...
      _push(`</div></div></div><div class="my-3 text-end"><button class="px-4 py-2 text-center text-white bg-black border-[2px] border-[#000] rounded-md me-4">Save</button><button class="px-4 py-2 text-center text-[#000] bg-transparent border-[2px] border-[#000] rounded-md">Next</button></div>`);
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</li><li class="nav-item position-relative border-0" role="presentation"><a id="" data-bs-toggle="pill" href="" class="${ssrRenderClass([[unref(investmentStore).investment_exemption_steps === 2 ? "active font-semibold" : "font-medium !text-[#8B8B8B]"], "text-center px-3 border-0 font-['poppins'] text-[12px] text-[#001820]"])}" role="tab" aria-controls="" aria-selected="true"> Section 80C &amp; 80CCC </a>`);
      ...
      _push(`</li><li class="nav-item position-relative border-0" role="presentation"><a id="" data-bs-toggle="pill" href="" class="${ssrRenderClass([[unref(investmentStore).investment_exemption_steps === 3 ? "active font-semibold " : "font-medium !text-[#8B8B8B]"], "text-center px-3 border-0 font-['poppins'] text-[12px] text-[#001820]"])}" role="tab" aria-controls="" aria-selected="true"> Other Exemptions </a>`);
      ...
      _push(`</li><li class="nav-item position-relative border-0" role="presentation"><a id="" data-bs-toggle="pill" href="" class="${ssrRenderClass([[unref(investmentStore).investment_exemption_steps === 4 ? "active font-semibold " : "font-medium !text-[#8B8B8B]"], "text-center px-3 border-0 font-['poppins'] text-[12px] text-[#001820]"])}" role="tab" aria-controls="" aria-selected="true"> House Property </a>`);
      ...
      if (unref(investmentStore).reimbursmentSource) {
        _push(`<li class="nav-item position-relative border-0" role="presentation"><a id="" data-bs-toggle="pill" href="" class="${ssrRenderClass([[unref(investmentStore).investment_exemption_steps === 5 ? "active font-semibold " : "font-medium !text-[#8B8B8B]"], "text-center px-3 border-0 font-['poppins'] text-[12px] text-[#001820]"])}" role="tab" aria-controls="" aria-selected="true"> Reimbursement </a>`);
      ...
      if (unref(investmentStore).previousEmployeerIncomeSource) {
        _push(`<li class="nav-item position-relative border-0" role="presentation"><a id="" data-bs-toggle="pill" href="" class="${ssrRenderClass([[unref(investmentStore).investment_exemption_steps === 6 ? "active font-semibold " : "font-medium !text-[#8B8B8B]"], "text-center px-3 border-0 font-['poppins'] text-[12px] text-[#001820]"])}" role="tab" aria-controls="" aria-selected="true"> Previous Employer Income </a>`);
      ...
      _push(`<li class="nav-item position-relative border-0" role="presentation"><a id="" data-bs-toggle="pill" href="" class="${ssrRenderClass([[unref(investmentStore).investment_exemption_steps === 7 ? "active font-semibold " : "font-medium !text-[#8B8B8B]"], "text-center px-3 border-0 font-['poppins'] text-[12px] text-[#001820]"])}" role="tab" aria-controls="" aria-selected="true"> Other Source Of Income </a>`);
      if (unref(investmentStore).investment_exemption_steps === 7) {
        _push(`<div class="h-1 rounded-r-3xl position-absolute bottom-[1px] w-[100%] left-0" style="${ssrRenderStyle({ "border": "2px solid #F9BE00 !important" })}"></div>`);
      } else {
        _push(`<div class="border-3 h-1 rounded-r-3xl border-gray-300"></div>`);
      }
      _push(`</li><div class="border-gray-300 border-b-[4px] w-100 mt-[-7px]"></div></ul><div class="tab-content" id="">`);
      if (unref(investmentStore).investment_exemption_steps === 1) {
        _push(`<div>`);
