...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 03, 2022 at 07:19 PM
...
INSERT INTO `vmt_employee_pms_goals_table` (`id`, `self_kpi_review`, `self_kpi_percentage`, `self_kpi_comments`, `manager_kpi_review`, `manager_kpi_percentage`, `manager_kpi_comments`, `hr_kpi_review`, `hr_kpi_percentage`, `hr_kpi_comments`, `kpi_table_id`, `assignment_period`, `coverage`, `reviewer_id`, `employee_id`, `mail_link`, `author_id`, `employee_kpi_status`, `is_employee_submitted`, `is_employee_accepted`, `is_manager_submitted`, `is_manager_approved`, `is_hr_submitted`, `created_at`, `updated_at`) VALUES
(47, '{\"45\":\"emp typed\"}', '{\"45\":\"emp typed\"}', '{\"45\":\"emp typed\"}', '{\"45\":\"mgr typed\"}', '{\"45\":\"mgr typed\"}', NULL, '{\"45\":\"HR types\"}', '{\"45\":\"HR types\"}', NULL, '27', 'Jan', NULL, '2', '4', 'http://localhost:8000/vmt-pmsappraisal-review', '2', NULL, 1, 1, 1, 1, '0', '2022-07-03 06:15:30', '2022-07-03 11:07:27');
...
(45, 'July 3 , 5:15pm', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2', 'Mgr Max Kumar', '2022-07-03 06:15:25', '2022-07-03 06:15:25');
