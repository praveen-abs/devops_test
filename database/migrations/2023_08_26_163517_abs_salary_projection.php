...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('abs_salary_projection', function (Blueprint $table) {

            $table->id();
            $table->foreignId('vmt_emp_payroll_id')->constrained('vmt_emp_payroll');
    ...
    {
        Schema::dropIfExists('abs_salary_projection');
    }
};
