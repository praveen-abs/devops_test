...
return new class extends Migration
{
    ...
    {
        dropColumnIfExists("vmt_emp_int_loan_details",'loan_status');
        dropColumnIfExists("vmt_emp_int_loan_details",'reviewer_cmds');
        dropColumnIfExists("vmt_emp_int_loan_details",'paid_date');
        dropColumnIfExists("vmt_emp_int_loan_details",'UTR_number');
    }
};
