...
class Seeder_VmtAppModuleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('vmt_app_modules')->insert([
            ...
            ['id'=>'4','module_name'=>'ATTENDANCE TIMESHEET',"title"=>'Attendance Timesheet'],
        ...
        DB::table('vmt_app_sub_modules')->insert([
            ...
            ['id'=>'4','sub_module_name'=>'CAN_CAPTURE_CHECKIN_LOCATION',"title"=>'Can capture location on Check-in?'],
            ['id'=>'5','sub_module_name'=>'CAN_CAPTURE_CHECKOUT_LOCATION',"title"=>'Can capture location on Check-out?'],
            ['id'=>'6','sub_module_name'=>'CAN_CAPTURE_CHECKIN_SELFIE',"title"=>'Can capture selfie on Check-in?'],
            ['id'=>'7','sub_module_name'=>'CAN_CAPTURE_CHECKOUT_SELFIE',"title"=>'Can capture selfie on Check-out?'],
            ['id'=>'8','sub_module_name'=>'CAN_CAPTURE_REIMBURSEMENT_ON_CHECKOUT',"title"=>'Can capture Reimbursement details on Check-out?'],
            ...
            ['id'=>'21','sub_module_name'=>'TIME_SHEET',"title"=>'time_sheet'],

            ['id'=>'22','sub_module_name'=>'MANAGE_EMPLOYEES',"title"=>'manage_employees'],
            ['id'=>'23','sub_module_name'=>'ORG_STRUCTURE',"title"=>'org_structure'],
            ['id'=>'24','sub_module_name'=>'ONBOARDING',"title"=>'onboarding'],
            ['id'=>'25','sub_module_name'=>'ONBOARDING_BULK_UPLOAD',"title"=>'onboarding bulk upload'],
            ['id'=>'26','sub_module_name'=>'ONBOARDING_QUICK_UPLOAD',"title"=>'onboarding quick upload'],
            ['id'=>'27','sub_module_name'=>'MANAGE_WELCOMEMAIL_STATUS',"title"=>'manage_welcomemail_status'],
            ['id'=>'28','sub_module_name'=>'ROLES_AND_PERMISSION',"title"=>'roles_and_permission'],

            ['id'=>'29','sub_module_name'=>'ONBOARDING',"title"=>'onboarding'],
            ['id'=>'30','sub_module_name'=>'LEAVES',"title"=>'leaves'],
            ['id'=>'31','sub_module_name'=>'ATTENDANCE_REGULARIZATION',"title"=>'attendance_regularization'],
            ['id'=>'32','sub_module_name'=>'REIMBURSEMENT',"title"=>'reimbursement'],
            ['id'=>'33','sub_module_name'=>'TAXATIONS',"title"=>'taxations'],
            ['id'=>'34','sub_module_name'=>'EMPLOYEE_DETAILS',"title"=>'employee_details'],
            ['id'=>'35','sub_module_name'=>'LOAN_AND_SALARY_ADVANCE',"title"=>'loan_and_salary_advance'],

            ['id'=>'36','sub_module_name'=>'SELF_APPRAISAL',"title"=>'self_appraisal'],
            ['id'=>'37','sub_module_name'=>'TEAM_APPRAISAL',"title"=>'team_appraisal'],
            ['id'=>'38','sub_module_name'=>'ORG_APPRAISAL',"title"=>'org_appraisal'],
            ['id'=>'39','sub_module_name'=>'PMS_CONFIG',"title"=>'pms_config'],
            ['id'=>'40','sub_module_name'=>'PMS_FORMS_MANAGEMENT',"title"=>'pms_forms_management'],

            ['id'=>'41','sub_module_name'=>'ANALYTICS',"title"=>'analytics'],
            ['id'=>'42','sub_module_name'=>'PAYRUN',"title"=>'payrun'],
            ['id'=>'43','sub_module_name'=>'MANAGE_PAYSLIPS',"title"=>'manage_payslip'],
            ['id'=>'44','sub_module_name'=>'CLAIM',"title"=>'claim'],
            ['id'=>'45','sub_module_name'=>'REPORTS',"title"=>'reports'],

            ['id'=>'47','sub_module_name'=>'SALARY_DETAILS',"title"=>'salary_details'],
            ['id'=>'48','sub_module_name'=>'INVESTMENTS',"title"=>'investments'],
            ['id'=>'49','sub_module_name'=>'FORM_16',"title"=>'form_16'],
            ['id'=>'50','sub_module_name'=>'LOAN_AND_SALARY_ADVANCE',"title"=>'loan _and_salary_advance'],
        ...
        DB::table('vmt_app_sub_modules_links')->insert([
            ...
            ['id'=>'54','module_id'=>'9','sub_module_id'=>'1'],
