...
class Seeder_VmtAppModuleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('vmt_app_sub_modules')->insert([
            ['id'=>'1','sub_module_name'=>'IS_MOBILEAPP_ENABLED',"internal_name"=>'mobile_app'],
            ['id'=>'2','sub_module_name'=>'CAN_CHECKIN',"internal_name"=>'check_in'],
            ['id'=>'3','sub_module_name'=>'CAN_CHECKOUT',"internal_name"=>'check-out'],
            ['id'=>'4','sub_module_name'=>'CHECKIN_LOCATION',"internal_name"=>'location_capture'],
            ['id'=>'5','sub_module_name'=>'CHECKIN_SELFIE',"internal_name"=>'check_in_selfie'],
            ['id'=>'6','sub_module_name'=>'CHECKOUT_SELFIE',"internal_name"=>'check_out_selfie'],
            ['id'=>'7','sub_module_name'=>'REIMBURSEMENT_ON_CHECKOUT',"internal_name"=>'reimbursement_while_check_out'],
            ...
            ['id'=>'10','sub_module_name'=>'CAN_APPLY_LEAVE',"internal_name"=>'leave_apply'],
