...
class Seeder_VmtAppModuleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('vmt_app_sub_modules')->insert([
            ...
            ['id'=>'18','sub_module_name'=>'SALARY_DETAILS',"title"=>'salary_details'],
            ['id'=>'19','sub_module_name'=>'INVESTMENTS',"title"=>'investments'],
            ['id'=>'20','sub_module_name'=>'FORM_16',"title"=>'form_16'],
            ['id'=>'21','sub_module_name'=>'LOAN_AND_SALARY_ADVANCE',"title"=>'loan _and_salary_advance'],
        ]);
        ...
        DB::table('vmt_app_sub_modules_links')->insert([
            ...
            ['id'=>'20','module_id'=>'4','sub_module_id'=>'1'],
            ['id'=>'21','module_id'=>'5','sub_module_id'=>'1'],
            ['id'=>'22','module_id'=>'6','sub_module_id'=>'1'],
            ['id'=>'23','module_id'=>'7','sub_module_id'=>'1'],
            ['id'=>'24','module_id'=>'8','sub_module_id'=>'1'],
            ['id'=>'25','module_id'=>'9','sub_module_id'=>'1'],
            ['id'=>'26','module_id'=>'7','sub_module_id'=>'18'],
            ['id'=>'27','module_id'=>'7','sub_module_id'=>'19'],
            ['id'=>'28','module_id'=>'7','sub_module_id'=>'20'],
            ['id'=>'29','module_id'=>'7','sub_module_id'=>'21'],
