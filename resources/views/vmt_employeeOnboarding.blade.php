  ...
  <div class="row">
    <div class="col-12 col-lg-8 ml-auto mr-auto mb-4">
      <div class="multisteps-form__progress">
        ...
        <button class="multisteps-form__progress-btn" type="button" title="Address">Location Details</button>
        <button class="multisteps-form__progress-btn" type="button" title="Order Info">Official Details</button>
        <button class="multisteps-form__progress-btn" type="button" title="Comments">Family Details</button>
        <button class="multisteps-form__progress-btn" type="button" title="Comments">Statutory Details</button>
      </div>
    </div>
  </div>
  <!--form panels-->
