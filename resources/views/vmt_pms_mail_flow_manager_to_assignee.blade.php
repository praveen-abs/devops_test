...
<body>
    @if($approvalStatus == "none")
        ...
        <p>&nbsp;&nbsp;&nbsp;This mail is to inform you regarding your respective KRA's/goals in conformation with your reporting manager for this year <b>{{ $appraisal_year }} - {{ $appraisal_period }} </b> and the same has been uploaded your HRMS login.
    ...
    @elseif ($approvalStatus == "rejected")
        {{-- <p>Personal Assessment goal has been rejected by your Manager</p> --}}
            ...
            <p>&nbsp;&nbsp;&nbsp;KRA/ KPI has been rejected by <b>“Mr. @php echo $user_manager_name;@endphp” </b>and reason stated below for your further references.</p>
                <p>  @php echo $comments_manager; @endphp </p>
