                ...
                <div class="d-flex justify-content-between align-items-center w-100">
                    ...
                    <div class="notify-content d-flex justify-content-center align-items-center">
                        ...
                        <div class="dropdown topbar-head-dropdown ms-1 ">
                            <button type="button" class="btn btn-icon bg-transparent outline-none border-0 btn-topbar rounded-circle text-muted" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="border: 0px;">
                                ...
                                <span class="badge fs-10 translate-middle  rounded-circle  bg-danger">{{$User = Auth::user()->unreadNotifications->count();}}</span>
                                @endif
