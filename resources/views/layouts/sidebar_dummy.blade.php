            ...
            <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <div class="collapse menu-dropdown" id="attendanceDrop-Down">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="#" class="nav-link sidebar py-1" role="button"><span>Attendance
                                    </span></a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link sidebar py-1" role="button"><span>Expenses &
                                        Travel</span></a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="PerformanceDrop-Down">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <!-- <a href="#" class="nav-link sidebar py-1"><span>Dashboard</span></a> -->
                                <a href="#" class="nav-link sidebar py-1"><span>Dashboard</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link"><span>Team Appraisal</span></a>
                            </li>
                                                        <li class="nav-item">
                ...
                <!-- pay check -->
                <li class="nav-item">
                    <a class="nav-link sidebar menu-link pt-0" id="employeeInfo" href="#" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebar360questions">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="claimsDrop-Down">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="#" id="" class="nav-link sidebar py-1" data-bs-toggle="collapse" role="button" aria-expanded="false"><span>
                                        Transaction</span> </a>
                            ...
                            <li class="nav-item tdItem">
                                <a href="#" id="tds" data-bs-toggle="collapse" role="button" aria-expanded="false" class="nav-link sidebar py-1"><span> Reports</span> </a>
                                <div class="collapse  menu-dropdown sub-dropdown" id="reportsDrop-Down">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="#" class="nav-link sidebar"><span>
                                                    Appraisal Reports</a>
                                            </span>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="reportsDrop-Down">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                ...
                                <a href="#" class="nav-link sidebar py-1" role="button"><span>Leave
                                        Report</span></a>
                            </li>
                            <li class="nav-item">
                ...
                <!-- help desk -->
                <li class="nav-item">
                    <a class="nav-link sidebar menu-link pt-0" href="#" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                    ...
                    <div class="collapse menu-dropdown" id="helpDeskDrop-down">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="#" class="nav-link sidebar  py-1"><span>Calendar</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link sidebar py-1"><span>Chat</span></a>
                            </li>
                            <li class="nav-item">
                                <a href="#" class="nav-link sidebar py-1"><span>Mail-Box</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="exitDrop-down">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item ">
                                <a href="#" id="" class="nav-link sidebar py-1"><span> Resignation
                                        Entry
                                    </span> </a>
                            </li>
                            <li class="nav-item ">
                                <a href="#" id="tds" class="nav-link sidebar py-1"><span>Resignation
                                        Status
                                    </span></a>
                            </li>
                        </ul>
