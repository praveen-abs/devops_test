                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item ">
                                <a href="{{ url('attendance_leave') }}" id=""
                                    class="nav-link sidebar py-1" aria-expanded="false"><span>Dashboard</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ url('attendance_leave') }}" id=""
                                    class="nav-link sidebar py-1" aria-expanded="false"><span>Self Leave</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ url('employeeOnboarding') }}" id=""
                                    class="nav-link sidebar py-1" aria-expanded="false"><span>Team Leave</span>
                                </a>
                            </li>
                            <li class="nav-item ">
                                <a href="{{ url('employeeOnboarding') }}" id=""
                                    class="nav-link sidebar py-1" aria-expanded="false"><span>Org Leave</span>
                                </a>
                            </li>
