    ...
    <div class="main-page">
        <div class="sub-page" style="text-align: justify;">
            <table cellspacing="0" cellpadding="0" class="payslip_table">
                    ...
                    <td colspan="7" class="border-less">
                        <div class="header-cotent" style="margin: 1px;">
                            ...
                            padding-left: 5px;font-size:18px;margin:0px;">
                                Units Chemical India Private Limited</p>
                            <p class="" style="margin:0px">No.31/1, Samy Pillai Street, Choolai</p>
                            <p class="" style="margin:0px">Perambur Barracks, Perambur,  Purasawalkam </p>
                            <p class="" style="margin:0px">Chennai, Tamil Nadu, India 600 112. </p>
                        </div>
                    </td>
                    <td colspan="5" class="border-less">
                        <div class="header-img txt-right" style="">
                            <img src="{{ URL::asset('/assets/clients/vasa/logos/logo_units_chemicals.jpg') }}"
                                style="height:82px;width:260px;padding-right:10px;" title="">
                        </div>
                    </td>
                </tr>
                ...
                @if (($employee_payslip->hra != 'null'&& $employee_payslip->hra !="0"))
                <tr>
                    <td colspan="2" class="">
                ...
                <tr>
                    <td colspan="2" class="">
                        <p class="txt-left text-strong">LTA</p>
                    </td>
                    <td colspan="2" class="">
                        @if ($employee_payslip->lta =="")
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                            style="padding-right:0px;">{{ number_format(round(0), 2) }}</p>
                        @else
                        <p class="txt-right"><img height="8.5" width="12"
                                src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                                style="padding-right:0px;">{{ number_format(round($employee_payslip->lta), 2) }}</p>
                        @endif
                    </td>
                    <td colspan="2" class="">
                        @if ($employee_payslip->lta_arrear =="")
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                        ...
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                            style="padding-right:0px;">{{ number_format(round($employee_payslip->lta_arrear), 2) }}
                         </p>
                        @endif

                    </td>
                    <td colspan="2" class="">
                        @if ($employee_payslip->earned_lta =="")
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                            style="padding-right:0px;">{{ number_format(round(0), 2) }}
                    </p>
                        ...
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                            style="padding-right:0px;">{{ number_format(round($employee_payslip->earned_lta), 2) }}
                         </p>
                        @endif
                ...
                <tr>
                    <td colspan="2" class="">
                        <p class="txt-left text-strong"> MEDICAL ALLOWANCE </p>
                    </td>
                    <td colspan="2" class="">
                        @if ($employee_payslip->medical_allowance !="")
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                            style="padding-right:0px;">{{ number_format(round($employee_payslip->medical_allowance), 2) }}
                    </p>
                        @else
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                    ...
                    <td colspan="2" class="">
                        @if ($employee_payslip->medical_allowance_arrear !="")
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                            style="padding-right:0px;">{{ number_format(round($employee_payslip->medical_allowance_arrear), 2) }}
                       </p>
                        @else
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                    ...
                    <td colspan="2" class="">
                        @if ($employee_payslip->medical_allowance_earned !="")
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                            style="padding-right:0px;">{{ number_format(round($employee_payslip->medical_allowance_earned), 2) }}
                        @else
                        <p class="txt-right"><img height="8.5" width="12"
                            src="{{ URL::asset('assets/images/inr_png.png') }}" class="txt-right" alt=""
                            style="padding-right:0px;">{{ number_format(round(0), 2) }}
