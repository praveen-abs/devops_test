...
<body>
    <table cellspacing="0" cellpadding="0" class="payslip_table">
        ...
        <tr>
            ...
            <td colspan="8" class="">
                <p class="txt-center ext-strong navy-blue">{{ number_format(round($employee_details->NET_TAKE_HOME), 2) }}</p>
            </td>
        </tr>
        <tr>
            <td colspan="4" class="bg-ash">
        ...
        <tr>
            <td colspan="12">
                <p class="txt-center "> <i class="navy-blue"> This is a computer-generated slip does not require signature</i>
                </p>
            </td>
        </tr>
        ...
        <tr class="border-less">
            <td colspan="8" class="border-less" style="    padding: 10px 0px;">
                <p class="txt-left navy-blue">Please
