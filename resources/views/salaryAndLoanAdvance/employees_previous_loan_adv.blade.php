            ...
            <div class="form-control">
                <div class="row">
                    <div class="col-md-5 col-xl-5 col-sm-12">
                        <h6 class="text-xl font-semibold"> Loan Data Upload</h6>
                        <div class="col col-form-label">
                            <ul class="list-style-numbered ">
                                <li class="my-4"><i class="text-green-500 fa fa-step-forward" aria-hidden="true"></i>
                                    Download


                                <li class="my-4">
                                    <form method="POST" id='role-form' action="{{ url('/inmport-loan-adv-excel-data') }}"
                                    ...
                                    for (var i = 0; i < ajaxData.data.length; i++) {
                                        ...
                                        if (ajaxData.status == 'failure') {
                                            ...
                                            for (var j = 0; j < keys.length; j++) {
                                                $('#error-msg').append('<p>&emsp;' + json_error_fields[keys[j]] +
                                                    '</p>');
                                            }
                                        }
