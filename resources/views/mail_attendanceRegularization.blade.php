                          ...
                          <tr>
                            <td>
                              <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                  <td>
                                    <p style="margin-top: 40px; font-weight: 600">Dear {{ $managerName }}</p>
                                  </td>
                                </tr>
                              </table>
                            </td>
                          ...
                          <tr style="width: 200px">
                            <td>
                              <table style="width: 240px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1); border: 1px solid gainsboro" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                <tr style="border-radius: 12px;">
                                  <td align="center" style="border-radius: 12px;">
                                    <p style="font-weight: 600; color: #1e3a8a"> Attendance Regularizations</p>
                              ...
                              <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td>
                                        <p style="text-align: center; font-weight: 600; color: #1e3a8a;">  {{ $employeeName }}</p>
                                      </td>
                                </tr>
                              </table>
                              <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td>
                                        <p style="text-align: center; color: #1e3a8a;"> Approve or Reject this request using the buttons below.</p>
                                      </td>
                                </tr>
                              </table>
                              <tr style="width: 100%;">
                          ...
                          <tr>
                            <td>
                              <p class="sm-text-sm" style="margin: 32px 0 20px; text-align: center; color: #334155">
                                When rejecting a regularization request, kindly include the reason for rejection in the response email,
                              </p>
                            </td>
                          </tr>
                        </table>
