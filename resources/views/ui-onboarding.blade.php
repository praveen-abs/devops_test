    ...
    <div id="msform">
        ...
        <form id="form-1" enctype="multipart/form-data" class=" ">
                        ...
                        <div class="row mt-1">
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="Employee Code" name="employee_code"
                                        id="employee_code" class=" form-control textbox" value="{{ $empNo }}"
                                ...
                                <div class="floating">
                                    ...
                                    @if (isset($employee_user->name))
                                        <input type="text" placeholder="Employee Name as per Aadhar "
                                            name="employee_name" id="employee_name" value="{{ $employee_user->name }}"
                                            class="onboard-form form-control textbox capitalize" pattern="name" readonly
                                            autofocus />
                                    @else
                                        <input type="text" placeholder="Employee Name as per Aadhar "
                                            name="employee_name" id="employee_name"
                                            class=" form-control textbox capitalize" pattern="name" required
                                            autofocus />
                                    @endif
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="Date of Birth" name="dob" id="dob"
                                        onfocus="(this.type='date')" max="{{ $date }}" value=""
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    <label for="" class="float-label">Marital Status <span
                                            class="text-danger">*</span></label>
                                    <select placeholder="Marital Status" name="marital_status" id="marital_status"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    @else
                                        <input type="text" max="9999-12-31" placeholder="Date of Joining"
                                            name="doj" class="onboard-form  form-control textbox "
                                ...
                                <div class="floating">
                                    ...
                                    @else
                                        <input type="text" placeholder="Mobile Number" name="mobile_no"
                                            id="mobile_no" minlength="10" value="" maxlength="10"
                                            oninput="numberOnly(this.id);" class="onboard-form form-control textbox "
                                            required />
                                    @endif
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    <label for="" class="float-label">Email<span
                                            class="text-danger">*</span></label>
                                    <input type="email" pattern="email" placeholder="Email ID" name="email"
                                        id="email"
                                        value="{{ !empty($employee_user) && $employee_user->email ? $employee_user->email : '' }}"
                                        class="  form-control textbox " onkeypress="return event.charCode != 32"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    <label for="" class="float-label">Aadhaar Number<span
                                            class="text-danger">*</span></label>
                                    <input type="text" oninput="numberOnly(this.id);" placeholder="Aadhaar Number"
                                        name="aadhar" id="vmt_aadhar"
                                        value="{{ !empty($employee_details) && $employee_details->aadhar_number ? $employee_details->aadhar_number : '' }}"
                                        pattern="aadhar" class="onboard-form form-control textbox " minlength="12"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 co l-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="Pan Card Number" name="pan_no"
                                        ...
                                        class=" form-control textbox  pan" pattern="pan" minlength="10"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="DL Number" name="dl_no" id="dl_no"
                                        ...
                                        minlength="16" maxlength="16" class="onboard-form form-control textbox "
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    <label for="" class="float-label">Passport Number<span
                                            class="text-danger" id="asterisk_passport_no"></span></label>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    <label for="" class="float-label">Passport Exp
                                        Date<span class="text-danger" id="asterisk_passport_expdate"></span></label>
                                    <input type="text" max="9999-12-31" placeholder="Passport Exp Date"
                                        name="passport_date" id="passport_date"
                                        class="onboard-form  form-control textbox " id="passdate"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <select placeholder="Blood Group" name="blood_group" id="blood_group"
                                        class="onboard-form form-control textbox   select2_form_without_search">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    ?>
                                    <select placeholder="Physically Challenged" name="physically_challenged"
                                        class="onboard-form form-control textbox  select2_form_without_search"
                                        required>
                                        <option value="" hidden selected disabled>Physically
                                            Challenged</option>
                                        <option value="yes" @if ($value == 'yes') selected @endif>Yes
                                        </option>
                                        <option value="no" @if ($value == 'no') selected @endif>No
                                        </option>
                                    </select>
                                ...
                                <div class="floating">
                                    ...
                                    <select placeholder="Bank Name" name="bank_name" id="bank_names"
                                        ...
                                        <option value="" hidden selected disabled>Select Bank
                                            Name</option>
                                        @foreach ($bank as $b)
                                            <option value="{{ $b->id }}" min-data="{{ $b->min_length }}"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="Account Number" name="account_no"
                                        id="account_no" class="onboard-form form-control textbox"
            ...
            <div class="card top-line">
                <div class="card-body ">
                    <h6 class="mb-0 text-start">Statutory Details</h6>
                    <div class="form-card">
                        <div class="row ">
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="UAN Number" name="uan_number" id="uan_number"
                                        minlength="12" maxlength="12" class="onboard-form form-control textbox "
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    ...
                                    <select placeholder="Ptax Location" name="ptax_location" id="ptax_location"
                                        class="onboard-form form-control textbox  select2_form_without_search">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    ...
                                    <select placeholder="TAX Regime" name="tax_regime" id="tax_regime"
                                        class="onboard-form form-control textbox  select2_form_without_search"
                                        required>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    ...
                                    <select placeholder="LWF Location" name="lwf_location" id="lwf_location"
                                        class="onboard-form form-control textbox  select2_form_without_search">
            ...
            <div class="card top-line">
                <div class="card-body ">
                    <h6 class="mb-0 text-start">Current Address</h6>
                    <div class="form-card">
                        <div class="row mt-1">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <select placeholder="Country" name="current_country" id="current_country"
                                        class="onboard-form form-control textbox  select2_form_without_search"
                                        required>
                                        <option value="" hidden selected disabled>Select
                                            Country</option>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    <label for="" class="float-label">State<span
                                            class="text-danger">*</span></label>
                                    <select placeholder="State" name="current_state" id="current_state"
                                        class="onboard-form form-control textbox  select2_form_without_search"
                                        required>
                                        <option value="" hidden selected disabled>Select
                                            State</option>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    <label for="" class="float-label"> City<span
                                            class="text-danger">*</span></label>
                                    <input type="text" placeholder="City" name="current_city" id="current_city"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" minlength="6" maxlength="6"
                                        oninput="numberOnly(this.id);" placeholder="Pincode" name="current_pincode"
                                        id="current_pincode" class="onboard-form form-control textbox "
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <select placeholder="Permanent State" name="permanent_state" id="permanent_state"
                                        class="onboard-form form-control textbox  select2_form_without_search"
                                        required>
                                        <option value=""></option>
                                    </select>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3  col-xxl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder=" City" name="permanent_city"
                                        id="permanent_city" class="onboard-form form-control textbox capitalize"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder=" Pincode" name="permanent_pincode"
                                        id="permanent_pincode" oninput="numberOnly(this.id);" minlength="6"
                                        maxlength="6" class="onboard-form form-control textbox "
            ...
            <div class="card top-line">
                <div class="card-body ">
                    ...
                    <h6 class="mb-0 text-start">Official Details</h6>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 col-xxl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="Designation" name="designation"
                                        class=" form-control textbox " pattern="alpha" required
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2 col-xl-3">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="Work Location" name="work_location"
                                        class="onboard-form form-control textbox capitalize" pattern="alpha" required
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2 col-xxl-3">
                                ...
                                <div class="floating">
                                    ...
                                    @if (!empty($emp_office_details->l1_manager_code))
                                        <input type="text" value="{{ $emp_office_details->l1_manager_code }}"
                                            name="l1_manager_code" id="l1_manager_code" class="form-control textbox "
                                            pattern="" readonly
                                    ...
                                    @else
                                        <select placeholder="Reporting Manager" name="l1_manager_code"
                                            id="l1_manager_code_select" class="onboard-form form-control  textbox ">
                                            <option value="" hidden selected disabled>Select
                                            </option>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2 col-xxl-3">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="Reporting Manager Name" name="l1_manager_name"
                                        id="l1_manager_name" class="textbox  onboard-form form-control "
                                        pattern="name"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="email" placeholder="Official E-Mail Id" name="officical_mail"
                                        class="textbox form-control " pattern="email"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" minlength="10" maxlength="10"
                                        placeholder="Official Mobile" name="official_mobile" id="official_mobile"
                                        oninput="numberOnly(this.id);" class="textbox  onboard-form form-control "
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    <label for="" class="float-label">Employee Notice
                                        Period Days</label>
                                    <input type="number" placeholder="Employee Notice Period Days" name="emp_notice"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    ...
                                    <input type="text" max="9999-12-31" placeholder="Date of confirmation"
                                        name="confirmation_period" id="confirmation_period"
            ...
            <div class="card top-line">
                <div class="card-body">
                    <h6 class="mb-0 text-start">Family Details</h6>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    ...
                                    <input type="text" max="9999-12-31" placeholder="Date of Birth"
                                        name="dob_father" id="dob_father" class="onboard-form form-control textbox  "
                                        onfocus="(this.type='date')" required />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="number" placeholder="Age" name="father_age" id="father_age"
                                        class="textbox  onboard-form form-control " minlength="2" maxlength="3"
                                        readonly
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    ...
                                    <input type="text" max="9999-12-31" placeholder="Date of Birth"
                                        name="dob_mother" id="dob_mother" class="textbox  onboard-form form-control "
                                        onfocus="(this.type='date')" required />
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                <div class="floating">
                                    ...
                                    <input type="text" class="form-control" name="mother_gender" id=""
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="number" placeholder="Age" name="mother_age" id="mother_age"
                                        class="textbox  onboard-form form-control " minlength="2" maxlength="3"
                                        readonly
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <input type="text" placeholder="Spouse Name" name="spouse_name"
                                        id="spouse_name" pattern="name"
                                        class="textbox  onboard-form form-control  spouse_data capitalize" required
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                <div class="floating">
                                    ...
                                    <select placeholder="Spouse Gender" name="spouse_gender" id="spouse_gender"
            ...
            <div class="card top-line ">
                <div class="card-body ">
                    ...
                    <h6 class="text-start">Compensatory</h6>
                                ...
                                @if (isset($compensatory->Statutory_bonus))
                                    <div class="floating">
                                        <label for="" class="float-label">Statutory
                                            Bonus</label>
                                        <input type="number" placeholder="Statutory Bonus" name="statutory_bonus"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                @if (isset($compensatory->other_allowance))
                                    <div class="floating">
                                        ...
                                        <input type="number" placeholder="Other Allowance" name="other_allowance"
                                ...
                                @if (isset($compensatory->gross))
                                    <div class="floating">
                                        ...
                                        <input type="number" placeholder="Gross Salary" name="gross"
                                            ...
                                            class="textbox  onboard-form form-control " step="0.01" required
                                            readonly />
                                    </div>
                                @else
                                    <div class="floating">
                                        ...
                                        <input type="number" placeholder="Gross Salary" name="gross"
                                            id="gross" class="textbox  onboard-form form-control "
                                ...
                                @if (isset($compensatory->cic))
                                    <div class="floating">
                                        ...
                                        <input type="number" placeholder="Cost of Company" name="cic"
                                            ...
                                            id="cic" class="onboard-form form-control textbox "
                                            step="0.01" required readonly />
                                    </div>
                                @else
                                    <div class="floating">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                ...
                                @if (isset($compensatory->esic_employee))
                                    <div class="floating">
                                        ...
                                        <input type="number" placeholder="ESIC Employee" name="esic_employee"
                                ...
                                @if (isset($compensatory->net_income))
                                    <div class="floating">
                                        ...
                                        <input type="number" placeholder="Net Income" name="net_income"
                                            ...
                                            class="onboard-form form-control textbox " step="0.01" required
                                            readonly />
                                    </div>
                                @else
                                    <div class="floating">
                                        ...
                                        <input type="number" placeholder="Net Income" name="net_income"
                                            id="net_income" class="onboard-form form-control textbox "
                                            step="0.01" required readOnly />
                                    </div>
                                @endif
            ...
            <div class="card top-line mb-0">
                <div class="card-body">
                    ...
                    <h6 class="text-start mb-0 ">Personal Documents</h6>
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2">
                                ...
                                <input type="file" accept="image/png, image/gif, image/jpeg"
                                    style="display:none;" placeholder="Aadhar Card" name="aadhar_card_file"
                                    id="aadhar_card_file" class="onboard-form form-control files" required />
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2" id="aadhar_card_backend_content">
                                ...
                                <div class="addfiles form-control" data="#aadhar_card_backend_file"
                                    id="aadhar_card_backend_file_label"><span class="file_label">Choose
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2">
                                ...
                                <div class="addfiles form-control" data="#pan_card_file" id="pan_card_file_label">
                                    <span class="file_label">Upload Pan
                                        Card</span>
                                </div>
                                <input type="file" accept="image/png, image/gif, image/jpeg"
                                    style="display:none;" placeholder="Pan Card" name="pan_card_file"
                                    id="pan_card_file" class="onboard-form form-control files" required />
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2">
                                <!-- <label class="" for="passport">Passport{!! required() !!}</label> -->
                                <label for="" class="float-label">
                                    Passport</label>
                                <div class="addfiles form-control" data="#passport_file" id="passport_file_label">
                                    <span class="file_label">Choose
                                        Passport</span>
                                </div>
                                <input type="file" accept="image/png, image/gif, image/jpeg"
                                    style="display:none;" placeholder="Passport" name="passport_file"
                                    id="passport_file" class="onboard-form form-control files" required />
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2">
                                ...
                                <div class="addfiles form-control" data="#voters_id_file"
                                    id="voters_id_file_label"><span class="file_label">Choose
                                        ...
                                        ID</span></div>
                                <input type="file" accept="image/png, image/gif, image/jpeg"
                                    style="display:none;" placeholder="Voters ID" name="voters_id_file"
                                    id="voters_id_file" class="onboard-form form-control files" required />
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2">
                                <!-- <label class="" for="dl_file">Driving License</label> -->
                                <label for="" class="float-label"> Driving
                                    License</label>
                                <div class="addfiles form-control" data="#dl_file" id="dl_file_label">
                                    <span class="file_label">Choose Driving
                                        License</span>
                                </div>
                                <input type="file" accept="image/png, image/gif, image/jpeg"
                                    style="display:none;" placeholder="Driving License" name="dl_file"
                                    id="dl_file" class="onboard-form form-control files" required />
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                                ...
                                <div class="addfiles form-control" data="#education_certificate_file"
                                    id="education_certificate_file_label"><span class="file_label">Choose
                                        Educations Certificate</span></div>
                                <input type="file" accept="image/png, image/gif, image/jpeg"
                                    style="display:none;" placeholder="Educations Certificate"
                                    name="education_certificate_file" id="education_certificate_file"
                                    class="onboard-form form-control files" required />
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-12 text-right"><button type="button" data="row-6" next="row-6"
                                placeholder="" name="save_form" id="save_button"
                                class="btn btn-orange  text-center processOnboardForm" value="Submit">Save</button>

                            <button disabled type="button" data="row-6" next="row-6" placeholder=""
        ...
        <div class="modal-dialog  modal-dialog-centered modal-dialog-scrollable  modal-md" role="document">
            <div class="modal-content top-line">
                ...
                <div class="modal-body">
                    ...
                    <div id="modalSubHeading" class="text-center">
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                <img src="{{ URL::asset('assets/images/saveData_draft.gif') }}" class="h-100 w-100"
                                    alt="user-pic">
                            </div>
                        </div>
                        <h6 class="text-muted m-0" id="">Successfully Data's Saved</h6>

                    </div>
                    <div id="SucessMail_send" class="text-center">
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                <img src="{{ URL::asset('assets/images/saveData_draft.gif') }}" class="h-100 w-100"
                                    alt="user-pic">
