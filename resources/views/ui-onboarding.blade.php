                                    ...
                                    <div class="form-card">
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="Marital Status" name="marital_status" id="marital_status" class="onboard-form form-control select2_form_without_search textbox" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" max="9999-12-31" placeholder="Date of Joining" name="doj" class="onboard-form textbox form-control " onfocus="(this.type='date')" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="Gender" name="gender" id="gender" class="onboard-form form-control select2_form_without_search textbox" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Pan Acknowlegement" name="pan_ack" pattern="alp-num" minlength="15" maxlength="15" id="pan_ack" class="onboard-form form-control not-required validate textbox" />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="Blood Group" name="blood_group" class="onboard-form form-control textbox not-required validate select2_form_without_search">
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Current City" name="current_city" id="current_city" class="onboard-form form-control textbox textbox" required />
                                    ...
                                    <div class="form-card">
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="ManagerCode" name="l1_manager_code" id="l1_manager_code" class="onboard-form form-control textbox" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Reporting Manager Name" name="l1_manager_name" id="l1_manager_name" class="onboard-form form-control textbox" pattern="name" required readonly />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="email" placeholder="Official E-Mail Id" name="officical_mail" class="onboard-form form-control textbox" required pattern="email" />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="number" minlength="10" maxlength="10" placeholder="Official Mobile" name="official_mobile" class="onboard-form form-control textbox" required />
                                ...
                                <div class="card-body justify-content-center align-items-center ">
                                    ...
                                    <div class="form-card">
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="Gender" name="father_gender" id="father_gender" class="onboard-form form-control textbox  select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <!-- <label class="" for="father_name">Father Name{!! required() !!}</label> -->
                                                <div class="floating">
                                                    <input type="number" placeholder="Age" name="father_age" class="onboard-form form-control textbox" minlength="2" maxlength="3" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Mother Name" name="mother_name" pattern="name" class="onboard-form form-control textbox" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <input type="text" max="9999-12-31" placeholder="Date of Birth" name="dob_mother" class="onboard-form form-control textbox" onfocus="(this.type='date')" required />
                                                    <label for="" class="float-label">Date of Birth</label>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="Gender" name="mother_gender" id="mother_gender" class="onboard-form form-control textbox  select2_form_without_search" required>
                                                        <option value="" hidden selected disabled>Gender</option>
                                                        <option value="male">Male</option>
                                                        <option value="female">Female</option>
                                                    </select>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <!-- <label class="" for="father_name">Father Name{!! required() !!}</label> -->
                                                <div class="floating">
                                                    <input type="number" placeholder="Age" name="mother_age" class="onboard-form form-control textbox" minlength="2" maxlength="3" required />
                                                    <label for="" class="float-label">Age</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Spouse Name" name="spouse_name" pattern="name" class="onboard-form form-control textbox spouse_data" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" max="9999-12-31" placeholder="Date of Wedding" name="dow" class="onboard-form form-control textbox spouse_data" onfocus="(this.type='date')" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="Spouse Gender" name="spouse_gender" id="spouse_gender" class="onboard-form form-control textbox spouse_data select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" max="9999-12-31" placeholder="Spouse DOB" name="spouse_dob" class="onboard-form form-control textbox spouse_data" onfocus="(this.type='date')" required />
                                    ...
                                    <div class="form-card">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Basic Salary" name="basic" value="{{$compensatory->basic? $compensatory->basic : ''}}" class=" textbox onboard-form form-control textbox calculation_data gross_data" step="0.01" required />
                                                    <label for="" class="float-label">Basic Salary</label>
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Basic Salary" name="basic" class="onboard-form form-control textbox calculation_data gross_data textbox " step="0.01" required />
                                                    <label for="" class="float-label">Basic Salary</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="HRA" name="hra" value="{{$compensatory->hra? $compensatory->hra : ''}}" class="onboard-form form-control textbox calculation_data gross_data textbox" step="0.01" required />
                                                    <label for="" class="float-label">HRA</label>
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="HRA" name="hra" class="onboard-form form-control textbox textbox calculation_data gross_data" step="0.01" required />
                                                    <label for="" class="float-label">HRA</label>
                                                </div>
                                                @php } @endphp
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Statutory Bonus" name="statutory_bonus" class="onboard-form form-control textbox calculation_data gross_data" step="0.01" required />
                                                    <label for="" class="float-label">Statutory Bonus</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Child Education Allowance" name="child_education_allowance" class="onboard-form form-control textbox calculation_data gross_data" step="0.01" required />
                                                    <label for="" class="float-label">Child Education Allowance</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Food Coupon" name="food_coupon" class="onboard-form form-control textbox calculation_data gross_data" step="0.01" required />
                                                    <label for="" class="float-label">Food Coupon</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="LTA" name="lta" value="{{$compensatory->lta? $compensatory->lta : ''}}" class="onboard-form form-control textbox calculation_data gross_data" step="0.01" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Special Allowance" name="special_allowance" class="onboard-form form-control textbox calculation_data gross_data" step="0.01" required />
                                                    <label for="" class="float-label">Special Allowance</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Other Allowance" name="other_allowance" value="{{$compensatory->other_allowance? $compensatory->other_allowance : ''}}" class="onboard-form form-control textbox calculation_data gross_data" step="0.01" required />
                                                    <label for="" class="float-label">Other Allowance</label>
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Other Allowance" name="other_allowance" class="onboard-form form-control textbox calculation_data gross_data" step="0.01" required />
                                                    <label for="" class="float-label">Other Allowance</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Gross Salary" name="gross" value="{{$compensatory->gross? $compensatory->gross : ''}}" class="onboard-form form-control textbox" step="0.01" required readOnly />
                                                    <label for="" class="float-label">Gross Salary</label>
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Gross Salary" name="gross" id="gross" class="onboard-form form-control textbox" step="0.01" required readOnly />
                                                    <label for="" class="float-label">Gross Salary</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="EPF employer contribution" name="epf_employer_contribution" value="{{$compensatory->epf_employer_contribution? $compensatory->epf_employer_contribution : ''}}" class="onboard-form form-control textbox calculation_data cic_data" step="0.01" required />
                                                    <label for="" class="float-label">EPF employer contribution</label>
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="EPF employer contribution" name="epf_employer_contribution" class="onboard-form form-control textbox calculation_data cic_data" step="0.01" required />
                                                    <label for="" class="float-label">EPF employer contribution</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Insurance" name="insurance" value="{{$compensatory->insurance? $compensatory->insurance : ''}}" class="onboard-form form-control textbox textbox calculation_data cic_data" step="0.01" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="EPF Employee" name="epf_employee" value="{{$compensatory->epf_employee? $compensatory->epf_employee : ''}}" class="onboard-form form-control textbox calculation_data net_data" step="0.01" required />
                                                    <label for="" class="float-label">EPF Employee</label>
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="EPF Employee" name="epf_employee" class="onboard-form form-control textbox calculation_data net_data" step="0.01" required />
                                                    <label for="" class="float-label">EPF Employee</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="ESIC Employee" name="esic_employee" value="{{$compensatory->esic_employee? $compensatory->esic_employee : ''}}" class="onboard-form form-control textbox calculation_data net_data" step="0.01" required />
                                                    <label for="" class="float-label">ESIC Employee</label>
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="ESIC Employee" name="esic_employee" class="onboard-form form-control textbox calculation_data net_data" step="0.01" required />
                                                    <label for="" class="float-label">ESIC Employee</label>
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Professional Tax" name="professional_tax" value="{{$compensatory->professional_tax? $compensatory->professional_tax : ''}}" class="onboard-form form-control textbox calculation_data net_data textbox" step="0.01" required />
                                                    <label for="" class="float-label">Professional Tax</label>
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Professional Tax" name="professional_tax" class="onboard-form form-control calculation_data net_data textbox" step="0.01" required />
                                                    <label for="" class="float-label">Professional Tax</label>
                                                </div>
                                                @php } @endphp
