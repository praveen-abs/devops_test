                                    ...
                                    <div class="form-card">
                                        <div class="row mt-1">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Employee Code" name="employee_code" class="onboard-form form-control " value="{{$empNo}}" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="number" placeholder="Mobile Number" name="mobile_no" minlength="10" maxlength="10" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="email" pattern="email" placeholder="Email ID" name="email" value="{{request()->has('email')? request()->email : ''}}" class="onboard-form  form-control " @if(request()->has('email')) readonly @endif required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="number" placeholder="Aadhaar Number" name="aadhar" id="vmt_aadhar" pattern="aadhar" class="onboard-form form-control " minlength="12" maxlength="12" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 co l-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Pan Card Number" name="pan_no" id="pan_num" class=" form-control  pan" pattern="pan" minlength="10" maxlength="10" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Pan Acknowlegement" name="pan_ack" pattern="alp-num" minlength="15" maxlength="15" id="pan_ack" class="onboard-form form-control not-required validate " />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="DL Number" name="dl_no" id="dl_no" minlength="15" maxlength="15" class=" form-control  not-required validate" pattern="dl" />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <input type="text" placeholder="Passport Number" name="passport_no" id="passport_no" minlength="8" maxlength="8" class="onboard-form form-control  not-required validate" />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="Bank Name" name="bank_name" id="bank_names" class="onboard-form form-control  select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <input type="number" placeholder="Account Number" name="account_no" id="account_no" class="onboard-form form-control " minlength="10" maxlength="10" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Bank IFSC Code" name="bank_ifsc" id="bank_ifsc" pattern="ifsc" class=" form-control " required />
                                ...
                                <div class="card-body justify-content-center align-items-center">
                                    <div class="form-card">
                                        ...
                                        <div class="row ">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="PF Applicable" name="pf_applicable" id="pf_applicable" class="onboard-form form-control  select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <input type="text" placeholder="EPF Number" name="epf_number" id="epf_number" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="UAN Number" name="uan_number" id="uan_number" minlength="10" maxlength="10" class="onboard-form form-control " required />
                                                    {{-- <label for="" class="float-label">UAN Number</label> --}}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="ESIC Applicable" name="esic_applicable" id="esic_applicable" class="onboard-form form-control  select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    maxlength="10" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="Ptax Location" name="ptax_location" id="ptax_location" class="onboard-form form-control  select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <input type="text" placeholder="TAX Regime" name="tax_regime" id="tax_regime" class="onboard-form form-control " required />
                                                    {{-- <label for="" class="float-label">TAX Regime</label> --}}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="LWF Location" name="lwf_location" id="lwf_location" class="onboard-form form-control  select2_form_without_search" required>
                                    ...
                                    <div class="form-card">
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Current City" name="current_city" id="current_city" class="onboard-form form-control  " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <!-- <label class="" for="current_pincode">Current Pincode{!! required() !!}</label> -->
                                                <div class="floating">
                                                    <input type="number" placeholder="Current Pincode" name="current_pincode" id="current_pincode" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="Country" name="current_district" id="current_country" class="onboard-form form-control  select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6 mb-2">
                                                ...
                                                <div class="floating">
                                                    <textarea placeholder="Current Address" name="current_address" id="current_address" class="onboard-form form-control " required id="" cols="5" rows="3"></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Permanent City" name="permanent_city" id="permanent_city" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="number" placeholder="Permanent Pincode" name="permanent_pincode" id="permanent_pincode" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="Permanent Country" name="permanent_district" id="permanent_country" class="onboard-form form-control  select2_form_without_search" required>
                                                        <option value="" hidden selected disabled>Select Country</option>
                                                        @foreach($countries as $data)
                                                        <option value="{{$data->country_code}}">{{$data->country_name}}
                                                        </option>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6 col-lg-6 mb-2">
                                                ...
                                                <div class="floating">
                                                    <textarea placeholder="Permanent Address" name="permanent_address" id="permanent_address" class="onboard-form form-control " required cols="5" rows="3"></textarea>
                                    ...
                                    <div class="form-card">
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Designation" name="designation" class="onboard-form form-control " pattern="alpha" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="number" placeholder="Cost Center" name="cost_center" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Work Location" name="work_location" class="onboard-form form-control " pattern="alpha" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="ManagerCode" name="l1_manager_code" id="l1_manager_code" class="onboard-form form-control " required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Reporting Manager Name" name="l1_manager_name" id="l1_manager_name" class="onboard-form form-control " pattern="name" required readonly />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="Holiday Location" name="holiday_location" id="holiday_location" class="onboard-form form-control  select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="email" placeholder="Official E-Mail Id" name="officical_mail" class="onboard-form form-control " required pattern="email" />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="number" minlength="10" maxlength="10" placeholder="Official Mobile" name="official_mobile" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="number" placeholder="Employee Notice Period Days" name="emp_notice" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <input type="text" max="9999-12-31" placeholder="Date of confirmation" name="dow" class="onboard-form form-control " onfocus="(this.type='date')" required />
                                ...
                                <div class="card-body justify-content-center align-items-center ">
                                    ...
                                    <div class="form-card">
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <input type="text" max="9999-12-31" placeholder="Date of Birth" name="dob_father" class="onboard-form form-control " onfocus="(this.type='date')" required />
                                                    {{-- <label for="" class="float-label">Date of Birth</label> --}}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="Gender" name="father_gender" id="father_gender" class="onboard-form form-control   select2_form_without_search" required>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Mother Name" name="mother_name" pattern="name" class="onboard-form form-control " required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <input type="text" max="9999-12-31" placeholder="Date of Birth" name="dob_mother" class="onboard-form form-control " onfocus="(this.type='date')" required />
                                                    {{-- <label for="" class="float-label">Date of Birth</label> --}}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    <select placeholder="Gender" name="mother_gender" id="mother_gender" class="onboard-form form-control   select2_form_without_search" required>
                                                        <option value="" hidden selected disabled>Gender</option>
                                                        <option value="male">Male</option>
                                                        <option value="female">Female</option>
                                                    </select>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <input type="text" placeholder="Spouse Name" name="spouse_name" pattern="name" class="onboard-form form-control  spouse_data" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    <select placeholder="Number of Children" name="no_of_child" id="no_of_child" class="onboard-form form-control  spouse_data select2_form_without_search" required>
                                    ...
                                    <div class="form-card">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Basic Salary" name="basic" value="{{$compensatory->basic? $compensatory->basic : ''}}" class="  onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Basic Salary</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Basic Salary" name="basic" class="onboard-form form-control  calculation_data gross_data  " step="0.01" required />
                                                    {{-- <label for="" class="float-label">Basic Salary</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="HRA" name="hra" value="{{$compensatory->hra? $compensatory->hra : ''}}" class="onboard-form form-control  calculation_data gross_data " step="0.01" required />
                                                    {{-- <label for="" class="float-label">HRA</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="HRA" name="hra" class="onboard-form form-control   calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">HRA</label> --}}
                                                </div>
                                                @php } @endphp
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Statutory Bonus" name="statutory_bonus" value="{{$compensatory->Statutory_bonus? $compensatory->Statutory_bonus : ''}}" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Child Education Allowance" name="child_education_allowance" value="{{$compensatory->child_education_allowance? $compensatory->child_education_allowance : ''}}" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Child Education Allowance</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Child Education Allowance" name="child_education_allowance" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Child Education Allowance</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Food Coupon" name="food_coupon" value="{{$compensatory->food_coupon? $compensatory->food_coupon : ''}}" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Food Coupon</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Food Coupon" name="food_coupon" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Food Coupon</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="LTA" name="lta" value="{{$compensatory->lta? $compensatory->lta : ''}}" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">LTA</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="LTA" name="lta" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">LTA</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Special Allowance" name="special_allowance" value="{{$compensatory->special_allowance? $compensatory->special_allowance : ''}}" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Special Allowance</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Special Allowance" name="special_allowance" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Special Allowance</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Other Allowance" name="other_allowance" value="{{$compensatory->other_allowance? $compensatory->other_allowance : ''}}" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Other Allowance</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Other Allowance" name="other_allowance" class="onboard-form form-control  calculation_data gross_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Other Allowance</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Gross Salary" name="gross" value="{{$compensatory->gross? $compensatory->gross : ''}}" class="onboard-form form-control " step="0.01" required readOnly />
                                                    {{-- <label for="" class="float-label">Gross Salary</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Gross Salary" name="gross" id="gross" class="onboard-form form-control " step="0.01" required readOnly />
                                                    {{-- <label for="" class="float-label">Gross Salary</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="EPF employer contribution" name="epf_employer_contribution" value="{{$compensatory->epf_employer_contribution? $compensatory->epf_employer_contribution : ''}}" class="onboard-form form-control  calculation_data cic_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">EPF employer contribution</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="EPF employer contribution" name="epf_employer_contribution" class="onboard-form form-control  calculation_data cic_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">EPF employer contribution</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="ESIC employer contribution" name="esic_employer_contribution" value="{{$compensatory->esic_employer_contribution? $compensatory->esic_employer_contribution : ''}}" class="onboard-form form-control  calculation_data cic_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">ESIC employer contribution</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="ESIC employer contribution" name="esic_employer_contribution" class="onboard-form form-control  calculation_data cic_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">ESIC employer contribution</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Insurance" name="insurance" value="{{$compensatory->insurance? $compensatory->insurance : ''}}" class="onboard-form form-control   calculation_data cic_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Insurance</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Insurance" name="insurance" class="onboard-form form-control  calculation_data cic_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Insurance</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Graduity" name="graduity" value="{{$compensatory->graduity? $compensatory->graduity : ''}}" class="onboard-form form-control  calculation_data cic_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Graduity</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Graduity" name="graduity" class="onboard-form form-control  calculation_data cic_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">Graduity</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Cost of Company" name="cic" value="{{$compensatory->cic? $compensatory->cic : ''}}" id="cic" class="onboard-form form-control " step="0.01" required readOnly />
                                                    {{-- <label for="" class="float-label">Cost of Company</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Cost of Company" name="cic" id="cic" class="onboard-form form-control " step="0.01" required readOnly />
                                                    {{-- <label for="" class="float-label">Cost of Company</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="EPF Employee" name="epf_employee" value="{{$compensatory->epf_employee? $compensatory->epf_employee : ''}}" class="onboard-form form-control  calculation_data net_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">EPF Employee</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="EPF Employee" name="epf_employee" class="onboard-form form-control  calculation_data net_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">EPF Employee</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="ESIC Employee" name="esic_employee" value="{{$compensatory->esic_employee? $compensatory->esic_employee : ''}}" class="onboard-form form-control  calculation_data net_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">ESIC Employee</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="ESIC Employee" name="esic_employee" class="onboard-form form-control  calculation_data net_data" step="0.01" required />
                                                    {{-- <label for="" class="float-label">ESIC Employee</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Professional Tax" name="professional_tax" value="{{$compensatory->professional_tax? $compensatory->professional_tax : ''}}" class="onboard-form form-control  calculation_data net_data " step="0.01" required />
                                                    {{-- <label for="" class="float-label">Professional Tax</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Professional Tax" name="professional_tax" class="onboard-form form-control calculation_data net_data " step="0.01" required />
                                                    {{-- <label for="" class="float-label">Professional Tax</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="labour welfare fund" name="labour_welfare_fund" value="{{$compensatory->labour_welfare_fund? $compensatory->labour_welfare_fund : ''}}" class="onboard-form form-control calculation_data net_data " step="0.01" required />
                                                    {{-- <label for="" class="float-label">labour welfare fund</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="labour welfare fund" name="labour_welfare_fund" class="onboard-form form-control calculation_data net_data " step="0.01" required />
                                                    {{-- <label for="" class="float-label">labour welfare fund</label> --}}
                                                </div>
                                                @php } @endphp
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Net Income" name="net_income" value="{{$compensatory->net_income? $compensatory->net_income : ''}}" class="onboard-form form-control " step="0.01" required readOnly />
                                                    {{-- <label for="" class="float-label">Net Income</label> --}}
                                                </div>
                                                @php }else{ @endphp
                                                <div class="floating">
                                                    <input type="number" placeholder="Net Income" name="net_income" id="net_income" class="onboard-form form-control " step="0.01" required readOnly />
                                                    {{-- <label for="" class="float-label">Net Income</label> --}}
                                                </div>
                                                @php } @endphp
                                    ...
                                    <div class="form-card mb-2">
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2">
                                                ...
                                                <div class="addfiles form-control" data="#aadhar_card" id="aadhar_card_label"><span class="file_label">Choose Aadhar
                                                        Card</span></div>
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2">
                                                ...
                                                <div class="addfiles form-control" data="#pan_card" id="pan_card_label"><span class="file_label">Choose Pan
                                                        Card</span></div>
