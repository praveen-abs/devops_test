...
<body style="margin: 0; width: 100%; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word">
    <div role="article" aria-roledescription="email" aria-label lang="en">
        <div class="sm-px-2"
            style="border-radius: 8px; font-family: ui-sans-serif, system-ui, -apple-system, 'Segoe UI', sans-serif; background-color: #D0DBF0">
                                                ...
                                                <table
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <p
                                                                style="margin: 0 0 12px; font-size: 30px; line-height: 24px; color:#F9BE00; margin-top:20px;">
                                                                <span
                                                                    style="margin: 0 0 12px; font-size: 30px; font-weight: 600; line-height: 24px">Pay
                                                                    Slip</span>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 100%;">
                                                            <p class="sm-text-sm"
                                                                style="margin: 0 0 16px; text-align: center; color: #334155">
                                                    ...
                                                    <tr>
                                                        <td style="width: 100%;">
                                                            <p class="sm-text-sm"
                                                                style="margin: 0 0 16px; text-align: center; color: #334155">
                                                                You can also view your payslip from the <a
                                                                    href=""
                                                                    style="color:#F9BE00; text-decoration:none;">ABSHrms
                                                                    Portal</a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="sm-text-sm"
                                                                style="margin: 32px 0 4px; color: #334155; text-align:center; margin-bottom:20px;">
                                                                This e-mail was generated from ABShrms if you think this
                                                                is SPAM,please do report to <a href=""
                                                                    style="color:#F9BE00;  text-decoration:none;">info@abshrms.com</a>
                                                            </p>
                                                        </td>
                                                    </tr>
                                                </table>
                                    ...
                                    <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
                                        <tr>
                                            <td style="text-align: center;">
                                                ...
                                                <p class="sm-text-sm" style="color: #334155; ">This e-mail was
                                                    generated from ABShrms, if
                                                    think
