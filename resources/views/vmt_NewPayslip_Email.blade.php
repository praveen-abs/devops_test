              ...
              <tr>
                <td class="sm-py-3 sm-px-2" style="padding: 12px">
                  <table class="sm-w-full" style="margin-left: auto; margin-right: auto; margin-top: 16px; width: 500px" cellpadding="0" cellspacing="0" role="none">
                    <tr>
                      <td>
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_logo.svg/1280px-Amazon_logo.svg.png" width="100" alt style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0; float: left">
                          ...
                          <tr>
                            <td style="width: 100%;">
                              <p class="sm-text-sm" style="margin: 0 0 16px; text-align: center; color: #334155">
                                Please find the attached payslip for the month of SEPTEMBER - 2001.
                              </p>
                            </td>
                          </tr>
                          <tr>
