    ...
    <div class="hr-dashboar-wrpper mt-30 ">
        ...
        <div class="row">
                                                        ...
                                                        @foreach ($announcementData as $singleAnnouncement)
                                                            <div class="announcement-content scrollBar">
                                                                <input class="form-control   w-100 h-100"
                                                                    value="{{ $singleAnnouncement->title_data }}"
                                                                    aria-label="default input example"
                                                                    placeholder="Title of the Announcement" type="text"
                                                                    id="title_data" name="title_data" readonly>
                                                                <input class="form-control   w-100 h-100"
                                                                    value="Date Posted : {{ \Carbon\Carbon::parse($singleAnnouncement->created_at)->format('M jS Y \\, h:i:s A') }}"
                                                                    aria-label="default input example"
                                                                    placeholder="Title of the Announcement" type="text"
                                                                    id="title_data" name="title_data" readonly>

                                                                <textarea class="form-control placeholder-glow w-100 h-100" style="text-align:left"
                                                                    placeholder="Details of Announcement" aria-label="default input example" type="text" name="details_data"
            ...
            <div class="col-sm-12 col-md-12 col-xl-4 col-lg-4 col-xxl-4 mb-3">
                <div class="calendar-wrapper card  border-0 ">
