                        ...
                        <table style="width: 100%; border-radius: 12px; background-color: #fff; padding-left: 32px; padding-right: 32px; padding-bottom: 20px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td>
                              <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                  <td>
                                    <p style="margin-top: 40px; font-weight: 700; font-size:20px;">Dear {{ $employeeName }}</p>
                                  </td>
                                </tr>
                              </table>
                            </td>
                          ...
                          <tr>
                            <td style="padding-top: 12px; padding-bottom: 12px">
                              <p>You have been sent the following “Attendance Regularizations”
                          ...
                          <tr style="width: 200px">
                            <td>
                              <table style="width: 240px; border-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1); border: 1px solid gainsboro" align="center" cellpadding="0" cellspacing="0" role="presentation">
                                <tr style="border-radius: 12px;">
                                  <td align="center" style="border-radius: 12px;">
                                    <p style="font-weight: 600; color: #1e3a8a">Attendance Regularizations Mail</p>
                              ...
                              <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td>
                                        <p style="text-align: center; font-weight: 600; color: #1e3a8a;">  {!! $mail_message !!}</p>
                                      </td>
                                </tr>
                              </table>
                              <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                    <td>
                                        <p style="text-align: center; color: #1e3a8a;">Please click the below link to regularize your attendance</p>
                                      </td>
                                </tr>
                              </table>
                              <tr style="width: 100%;">
                                <td style="text-align: center;">
                                  <table style="margin-top: 20px;margin-bottom: 20px; width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                                    <tr>
                                      <td> <a href="{{ $loginLink }}" class="hover-bg-green-700 sm-mx-3" style="border-radius: 9999px; background-color: #22c55e; padding: 8px 16px; font-size: 14px; font-weight: 600; color: #fff; text-decoration: none">
