                                ...
                                <div class="main-page">
                                    <div class="sub-page">
                                        <table class="policy_table  ">
                                            <tbody>
                                                <tr class="">
                                                    <td colspan="8" align="right" class="pad-bottom-15">
                                                        <div class="logo" style="height: 65px;width:180px;">
                                    ...
                                    <div class="sub-page">
                                        <table class="policy_table  ">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="8" align="" class=" pad-bottom-15 pad-top-10">
                                                ...
                                                ">
                                                    ...
                                                    <td colspan="7" align="" class="pad-top-5 ">
                                                        <p>Maternity Leave – 12 weeks (as per the Maternity Benefits Act)
                                                        </p>
                                                    </td>
                                                ...
                                                ">
                                                    ...
                                                    <td colspan="7" align="" class="pad-top-5  ">
                                                        <p> Paternity Leave – 15 days (Only For Males)</p>
                                                    </td>

                                                </tr>

                                                <tr>
                                                    <td colspan="8" align="" class="pad-bottom-10 pad-top-10">
                                                        <span class="border-b   text-strong">
                                                ...
                                                ">
                                                    ...
                                                    <td colspan="7" align="" class="pad-top-5 ">
                                                        <p> Employees availing more than 2 days of Sick leave / Casual Leave
                                                ...
                                                ">
                                                    ...
                                                    <td colspan="7" align="" class="pad-top-5 ">
                                                        <p>
                                                            Sick Leave / Casual Leave of more than 3 days will get prior
                                                            approval from the HR
                                                            Department.
                                        ...
                                        <table class="policy_table  ">
                                            <tbody>
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td colspan="7" align="" class="pad-top-5 ">
                                                        <p>Earned Leave can be carried forward to next year and the maximum
                                                            ...
                                                            days and accumulated earned leave will be enchased at the time
                                                            of Exit.
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr class="">
                                                    ...
                                                    <td colspan="7" align="" class="pad-top-5  ">
                                                        <p>Employees can avail max 5 days as planned leave; more than 5 days
                                                            will be treated as LOP</p>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td colspan="8" align="" class=" pad-bottom-25">
                                                        <table class="policy-table">
                                                            <tbody>
                                                                ...
                                                                <tr class="border-none-left-right ">
                                                                    <td colspan="2" align=""
                                                                        class="text-strong">
                                                                        <p class="">
                                                                            &nbsp;
