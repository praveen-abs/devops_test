                          ...
                          <tr style="margin-top: 20px">
                            <td style="text-align: center">
                              <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                  <td>
                                    <img src="{{ URL::asset("assets\images\anniversary.png")}}" alt style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0; height: 64px; width: 64px; padding: 12px">
                                  </td>
                                </tr>
                              </table>
                            </td>
