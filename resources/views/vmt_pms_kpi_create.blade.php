                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <button type="button" class="btn btn-primary mx-2 w-50" id="upload-goal"><i
                                                class="ri-file-upload-fill mx-1"></i> Upload</button>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-xl-4 col-sm-12">
                                    {{-- <div class=" d-flex align-items-center"> --}}
                                        ...
                                        <a href="{{ url('/assets/sample_kpi.xls') }}" target="_blank"
                                            class="btn btn-primary mx-2"><i class="ri-file-download-fill mx-1"></i>
                                            Sample File
                                        </a>
                                    {{-- </div> --}}
                                </div>
                ...
                <div class="col-12">
                    <div class="container-fluid mb-1 mt-3 ">
                                    ...
                                    <thead class="bg-primary thead" id="tHead">
                                        <tr class="text-uppercase">
                                            ...
                                            <th class="sort" data-sort="customer_name" data-name='dimension'
                                                data-filterable="false" data-visible="{{ $show['dimension'] }}">
                                            ...
                                            <th class="sort" data-sort="product_name" data-name='kpi'
                                                data-filterable="false" data-visible="{{ $show['kpi'] }}">
                                                @if ($config && $config->header)
                                                    {{ $config->header['kpi'] }}
                                                @else
                                                    KPI
                                            ...
                                            <th class="sort" data-sort="date" data-name='operational'
                                                data-filterable="false" data-visible="{{ $show['operational'] }}">
                                                @if ($config && $config->header)
                                            ...
                                            <th class="sort" data-sort="amount" data-name='measure'
                                                data-filterable="false" data-visible="{{ $show['measure'] }}">
                                                @if ($config && $config->header)
                                            ...
                                            <th class="sort" data-sort="payment" data-name='frequency'
                                                data-filterable="false" data-visible="{{ $show['frequency'] }}">
                                                @if ($config && $config->header)
                                            ...
                                            <th class="sort" data-sort="status" data-name='target'
                                                data-filterable="false" data-visible="{{ $show['target'] }}">
                                                @if ($config && $config->header)
                                            ...
                                            <th class="sort" data-sort="status" data-name='stretchTarget'
                                                data-filterable="false" data-visible="{{ $show['stretchTarget'] }}">
                                                @if ($config && $config->header)
                                            ...
                                            <th class="sort" data-sort="status" data-name='source'
                                                data-filterable="false" data-visible="{{ $show['source'] }}">
                                                @if ($config && $config->header)
                                            ...
                                            <th class="sort" data-sort="status" data-name='kpiWeightage'
                                                data-filterable="false" data-visible="{{ $show['kpiWeightage'] }}">
                                                @if ($config && $config->header)
                                    ...
                                    <tbody class="tbody content-container" id="tbody">
                                        <tr class="addition-content cursor-pointer" id="content1">
                                            ...
                                            <td class="text-box-td" style="background: #002F56">
                                                <textarea data-show="{{ $show['dimension'] }}" name="dimension[]" id="dimension" class="text-box" row="2"
                                                    cols="20" placeholder="type here" style="background: #002F56;color:#fff;"></textarea>
                                            </td>
                                            <td class="text-box-td ">
                                                <textarea data-show="{{ $show['kpi'] }}" name="kpi[]" id="" class="text-box" row="2"
                                                    cols="20" placeholder="type here"></textarea>
                                            </td>
                                            <td class="text-box-td ">
                                                <textarea data-show="{{ $show['operational'] }}" name="operational[]" id="" class="text-box"
                                                    row="2" cols="20" placeholder="type here"></textarea>
                                            </td>
                                            <td class="text-box-td ">
                                                <textarea data-show="{{ $show['measure'] }}" name="measure[]" id="" class="text-box" row="2"
                                                    cols="20" placeholder="type here"></textarea>
                                            </td>
                                            <td class="text-box-td ">
                                                <textarea data-show="{{ $show['frequency'] }}" name="frequency[]" id="" class="text-box" row="2"
                                                    cols="20" placeholder="type here"></textarea>
                                            </td>
                                            <td class="text-box-td ">
                                                <textarea data-show="{{ $show['target'] }}" name="target[]" id="" class="text-box" row="2"
                                                    cols="20" placeholder="type here"></textarea>
                                            </td>
                                            <td class="text-box-td ">
                                                <textarea data-show="{{ $show['stretchTarget'] }}" name="stretchTarget[]" id="" class="text-box"
                                                    row="2" cols="20" placeholder="type here"></textarea>
                                            </td>
                                            <td class="text-box-td ">
                                                <textarea data-show="{{ $show['source'] }}" name="source[]" id="" class="text-box" row="2"
                                                    cols="20" placeholder="type here"></textarea>
                                            </td>
                                            <td class="text-box-td ">
                                                <textarea data-show="{{ $show['kpiWeightage'] }}" name="kpiWeightage[]" id="" class="text-box"
                                                    row="2" cols="20" placeholder="type here"></textarea>
                                            </td>
                                        </tr>
                        ...
                        <div class="align-items-center justify-content-end d-flex mt-2 cursor-pointer">
                            <span class="plus-sign  "><i class="fa fa-plus f-20"></i>Add More</span>
                        </div>
...
@section('script')
                    ...
                    success: function(data) {
                        ...
                        $.each(data[0], function(key, value) {
                            ...
                            if (showdimension == 'block') {
                                dimension =
                                    '<td class="text-box-td p-1"><textarea name="dimension[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here">' +
                                    value[0] + '</textarea></td>';
                            } else {
                            ...
                            if (showkpi == 'block') {
                                kpi =
                                    '<td class="text-box-td p-1"><textarea name="kpi[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here">' +
                                    value[1] + '</textarea></td>';
                            } else {
                            ...
                            if (showoperational == 'block') {
                                operational =
                                    '<td class="text-box-td p-1"><textarea name="operational[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here">' +
                                    value[2] + '</textarea></td>';
                            } else {
                                operational =
                            ...
                            if (showmeasure == 'block') {
                                measure =
                                    '<td class="text-box-td p-1"><textarea name="measure[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here">' +
                                    value[3] + '</textarea></td>';
                            } else {
                            ...
                            if (showfrequency == 'block') {
                                frequency =
                                    '<td class="text-box-td p-1"><textarea name="frequency[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here">' +
                                    value[4] + '</textarea></td>';
                            } else {
                            ...
                            if (showtarget == 'block') {
                                target =
                                    '<td } class="text-box-td p-1"> <textarea name="target[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here">' +
                                    value[5] + '</textarea></td>';
                            } else {
    ...
    <script>
        $('body').on('click', '.plus-sign', function() {
            ...
            if (showdimension == 'block') {
                dimension =
                    '<td class="text-box-td p-1"><textarea name="dimension[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here"></textarea></td>';
            } else {
                dimension = '<input type="hidden" name="dimension[]">';
            }
            if (showkpi == 'block') {
                kpi =
                    '<td class="text-box-td p-1"><textarea name="kpi[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here"></textarea></td>';
            } else {
                kpi = '<input type="hidden" name="kpi[]">';
            }
            if (showoperational == 'block') {
                operational =
                    '<td class="text-box-td p-1"><textarea name="operational[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here"></textarea></td>';
            } else {
                operational = '<input type="hidden" name="operational[]">';
            }
            if (showmeasure == 'block') {
                measure =
                    '<td class="text-box-td p-1"><textarea name="measure[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here"></textarea></td>';
            } else {
                measure = '<input type="hidden" name="measure[]">';
            }
            if (showfrequency == 'block') {
                frequency =
                    '<td class="text-box-td p-1"><textarea name="frequency[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here"></textarea></td>';
            } else {
                frequency = '<input type="hidden" name="frequency[]">';
            }
            if (showtarget == 'block') {
                target =
                    '<td } class="text-box-td p-1"> <textarea name="target[]" data-show="true" id="" class="text-box" cols="20" placeholder="type here"></textarea></td>';
            } else {
                target = '<input type="hidden" name="target[]">';
            }
            if (showstretchTarget == 'block') {
