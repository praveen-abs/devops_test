                    ...
                    <div class="tab-pane fade" id="paycheck_det" role="tabpanel" aria-labelledby="">
                        <div class="card">
                            <div>
                                ...
                                <div id="paycheck_det" class="ember-view">
                                ...
                                <div class="card mb-2">
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content " id="pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="pay_slips" role="tabpanel"
                                                aria-labelledby="">
                                                <div class="row">
                            ...
                            <div class="modal-content top-line">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="col-12">
                                        <div class="text-right">
                                            <button
                                                id="btn_submit_address"class="btn btn-orange submit-btn">Submit</button>
                                        </div>
                                    </div>
                                    </form>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input name="bank_ifsc" class="form-control onboard-form"
                                                    value="{{ $user_full_details->bank_ifsc_code ?? '' }}"
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content profile-box  ">
                                ...
                                <div class="col-12">
                                    <div class="text-right">
                                        <button
                                            id="btn_submit_statutory_info"class="btn btn-orange submit-btn">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
