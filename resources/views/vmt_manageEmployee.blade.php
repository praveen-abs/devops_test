        ...
        <div class="card  left-line mb-2">
            <div class="card-body  pb-0 pt-1">
                <ul class="nav nav-pills nav-tabs-dashed" role="tablist">
                    ...
                    <li class="nav-item text-muted" role="presentation">
                        <a class="nav-link  pb-2" data-bs-toggle="tab" href="#exit_employees" aria-selected="true"
                            role="tab">
                            Exit Employee
                        </a>
                    </li>
    ...
    <script>
        ...
        $(document).ready(function() {
                        ...
                        },
                        {
                            ...
                            formatter: function formatter(enc_user_id) {
                                ...
                                var htmlcontent = '<a href="' + routeURL +
                                    '" class="btn btn-border-primary outline-none  mx-1"><i class="fa fa-user me-2  fw-bold"></i>View</a>';
                        ...
                        },
                        {
                            ...
                            formatter: function formatter(emp) {
                                ...
                                if (emp.is_onboarded == "1" && emp.is_docs_approved == "1")
                                    ...
                                    htmlcontent =
                                    '<input type="button" value="Activate" class="status badge bg-info py-1 onboard-employee-btn disabled"></input>';
            ...
            if (document.getElementById("exit_employeeTable")) {
                ...
                }).render(document.getElementById("exit_employeeTable")); // card Table
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            formatter: function formatter(enc_user_id) {
                                ...
                                var htmlcontent = '<a href="' + routeURL +
                                    '" class="btn btn-border-primary outline-none bg-transparent   mx-1"><i class="fa fa-user me-2  fw-bold"></i>View</a>';
