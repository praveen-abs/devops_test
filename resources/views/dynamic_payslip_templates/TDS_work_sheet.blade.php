    ...
    <table style="width: 100%; border-collapse: collapse;" >
        <tr>
            <td colspan="3">
                ...
                <p style="margin-top:-4px; font-size:11px;width:400px; font-weight:700; color:gray; ">Ardens Business Solutions Private Limited NO. 43, Pallavaram Main Road,
                    Managcherry, Kundrathur, Chennai Tamil Nadu 600069 India</p>
            </td>
            <td colspan="1">
              <img src="https://www.w3schools.com/images/lamp.jpg" class="float-right" height="40px" width="120px" alt="">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <h1  style="font-size:14px; color:rgba(0, 0, 0, 0.833)">TDS WORK SHEET <span  style="font-size:12px;color:gray">for the month of July 2023</span></h1></td>
                <td  colspan="3"> 
               </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2">
                <h1 style="font-size:11px;color:rgba(0, 0, 0, 0.833); margin-top:12px;">Details of salary paid and any other income and tax deducted</h1>
            </td>
        </tr>
    </table>
</body>
