            ...
            <table style="width: 90%" cellpadding="0" cellspacing="0" role="none">
                    ...
                    <tr>
                      <td>
                        ...
                        <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
                          <tr style="width: 100%;">
                            <td>
                              <p style="display: flex; height: 8px; font-size: 14px; color: #6b7280;">ACTUAL PAYABLE DAYS</p>
                              <p style="display: flex; font-weight: 600; color: #000;">{{ $salary_details[0]['month_days'] }}</p>
                            </td>
                            <td>
                              <p style="display: flex; height: 8px; font-size: 14px; color: #6b7280;">TOTAL WORKING DAYS</p>
                              <p style="display: flex; border-width: 1px; border-color: #000; font-weight: 600; color: #000;">{{ $salary_details[0]['worked_Days'] }}</p>
                            </td>
                            <td>
                              <p style="display: flex; height: 8px; font-size: 14px; color: #6b7280;">LOSS OF PAY DAYS</p>
                              <p style="display: flex; font-weight: 600; color: #000;">{{ $salary_details[0]['lop'] }}</p>
                            </td>
                            <td>
                              <p style="margin-bottom: 0; display: flex; height: 8px; font-size: 14px; color: #6b7280;">DAYS PAYABLE</p>
                              <p style="display: flex; font-weight: 600; color: #000;">{{ $salary_details[0]['worked_Days'] }}</p>
                            </td>
                          </tr>
                        </table>
                        <table border="1" style="border-color: #f3f4f6; width: 100%;" cellpadding="0" cellspacing="0" role="none">
                ...
                <td style="width: 100%;">
                  <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
                    <tr style="margin-left: 45px; display: flex; width: 100%; justify-content: center">
                      <td style="width: 40%">
                        <p style="height: 16px; color: #000">Net Salary Payable ( A - B - C ) </p>
                        <p style="height: 8px; color: #000;">Net Salary in words</p>
                      </td>
                      <td style="width: 70%">
                        <p style="height: 16px; color: #000;">{{ $over_all[0]['Net_Salary_Payable'] }}</p>
                        <p style="height: 16px; font-weight: 700; color: #000;">{{$over_all[0]['Net_Salary_in_words']}}</p>
                      </td>
                    </tr>
                  </table>
                </td>
              ...
              <tr style="height: 100px; width: 100%">
                ...
                <td style="display: flex; width: 65%; justify-content: flex-start">
                  <p style="margin-left: 56px; color: #000">*This is computer generated statement, does not require signature.</p>
                </td>
              </tr>
