...
<body>
    <table style="width: 100%;  border-collapse: collapse; background:#fff;  ">
        ...
        <tr class="td" style="height: 20px">
            ...
            <td style="width:25%;">
                <p style="font-size:10px;color:#383838;">DAYS PAYABLE</p>
                                    ...
                                    <td style="width:20%">
                                        @if ($earned_key == 'Basic' || $earned_key == 'HRA')
                                            @foreach ($compensatory_data as $key => $single_value)
                                                <h1
                                                    style="color: #000;font-size:11px; border:1px solid #000 !important ;  line-height:6px !important;">
                                                    {{ $single_value[$earned_key] }}</h1>
                                            @endforeach
                                        @endif
                                    </td>
                                    <td style="width:20%">
                    ...
                    <table
                        ...
                        @foreach ($earnings[0] as $earned_key => $single_earnings)
                            @if ($earned_key == 'Total Earnings')
                                <tr>
                                    <td style="width:40%">
                                        <h1 style="height: 8px; font-size:11px; color: #000;line-height:6px !important; ">
                                            {{ $earned_key . '(A)' }} </h1>
                                    </td>
                                    <td style="width:20%">
                                        @if ($earned_key == 'Basic' || $earned_key == 'HRA')
