                        ...
                        <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
                          <tr style="width: 100%;">
                            ...
                            <td>
                              ...
                              <p style="display: flex; font-weight: 600; color: #000;">{{ empty($personal_details[0]['epf_number']) ? " - " : $personal_details[0]['epf_number'] }}</p>
                            </td>
                          </tr>
                        </table>
                      </td>
                        ...
                        <table style="width: 100%;" cellpadding="0" cellspacing="0" role="none">
                          <tr style="width: 100%;">
                            ...
                            <td>
                              ...
                              <p style="display: flex; font-weight: 600; color: #000;">{{ $salary_details[0]['arrears_Days']}}</p>
                            </td>
                          </tr>
                        </table>
                        <table border="1" style="border-color: #f3f4f6; width: 100%;" cellpadding="0" cellspacing="0" role="none">
