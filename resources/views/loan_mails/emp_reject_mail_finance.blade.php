                                                    ...
                                                    <tr>
                                                        <td>
                                                            <p class="sm-text-sm"
                                                                ...
                                                                This is to provide you with an update on your recent
                                                                {{ $loan_type }} request, Request ID -
                                                                {{ $requestID }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <p class="sm-text-sm"
                                                                ...
                                                                that your {{ $loan_type }} request has been rejected
                                                                by Finance Team.
                                                                the decision was made based on the reason mentioned in
                                                                the below {{ $reviewer_comments }}
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <tr>
