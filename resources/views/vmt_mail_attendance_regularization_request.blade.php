                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                      ...
                                      <p class="text-start ">Dear {{ $managerName }}</p>
                                      <p class="text-start ">Employee {{ $employeeName}} has requested for attendance regularization for the date : {{$attendance_date}}.</p>
                                      <p class="text-start ">Kindly check your HRMS portal for more information.</p>


                                        <a href="{{$loginLink}}" style="background:blue;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;" type="submit">View Request</a>
