            ...
            <div class="card-body">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane show fade active" id="offer_pending" role="tabpanel"
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-sm-8 col-lg-8 col-md-8 col-xxl-8"></div>
                            <div class="col-xl-4 col-sm-4 col-lg-4 col-md-4 col-xxl-4"></div>
                        </div>
                        <div id="vjs_offerletter_module"></div>

                    </div>

                    <div class="tab-pane  fade " id="offer_completed" role="tabpanel"
                        aria-labelledby="pills-profile-tab">
