                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="view-file" data-src="{{ URL::asset('employee_documents/'.$user_code.'/'.$documents_filenames[0]->aadhar_card_file) }}" style="cursor:pointer">
                                                        {{"View Documents"}}
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="view-file" data-src="{{ URL::asset('employee_documents/'.$user_code.'/'.$documents_filenames[0]->aadhar_card_backend_file) }}" style="cursor:pointer">
                                                        {{"View Documents"}}
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="view-file" data-src="{{ URL::asset('employee_documents/'.$user_code.'/'.$documents_filenames[0]->pan_card_file) }}" style="cursor:pointer">
                                                        {{"View Documents"}}
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>Passport</td>
                                                <td>
                                                    <div class="view-file" data-src="{{ URL::asset('employee_documents/'.$user_code.'/'.$documents_filenames[0]->passport_file) }}" style="cursor:pointer">
                                                        {{"View Documents"}}
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>Voters ID</td>
                                                <td>
                                                    <div class="view-file" data-src="{{ URL::asset('employee_documents/'.$user_code.'/'.$documents_filenames[0]->voters_id_file) }}" style="cursor:pointer">
                                                        {{"View Documents"}}
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="view-file" data-src="{{ URL::asset('employee_documents/'.$user_code.'/'.$documents_filenames[0]->dl_file) }}" style="cursor:pointer">
                                                        {{"View Documents"}}
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <img class="w-100 h-100 soc-det-img "
                                                            ...
                                                            alt="Aadhar Card Front"> -->
                                                    <div class="view-file" data-src="{{ URL::asset('employee_documents/'.$user_code.'/'.$documents_filenames[0]->education_certificate_file) }}" style="cursor:pointer">
                                                        {{"View Documents"}}
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="view-file" data-src="{{ URL::asset('employee_documents/'.$user_code.'/'.$documents_filenames[0]->reliving_letter_file) }}" style="cursor:pointer">
                                                        {{"View Documents"}}
                                                    </div>
                                                </td>
                                                <td>
