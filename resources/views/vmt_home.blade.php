    ...
    @section('css')
        ...
        <style type="text/css">
            ...
            .force-overflow::-ms-thumb,
            .force-overflow::-moz-range-thumb,
                                ...
                                <div class="col-8 d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class=" d-flex align-items-center mx-2 flex-column">
                                            ...
                                            <span>Take Home</span>
                                            <span
                                                class="font-large font-mediumbold f-12">₹{{ json_decode($json_PayCheck)->NET_TAKE_HOME }}</span>
                                        </div>
                                        <div class=" d-flex align-items-center mx-2 flex-column">
                                            <div class="deductions-bar"></div>
                                            <span>Deductions</span>
                                            <span
                                                class="font-large font-mediumbold f-12 ">₹{{ json_decode($json_PayCheck)->TOTAL_DEDUCTIONS }}</span>
                                        </div>
                                        <div class=" d-flex align-items-center mx-2 flex-column">
                                            <div class="cross-pay-bar "></div>
                                            <span>Cross Pay</span>
                                            <span
                                                class="font-large font-mediumbold f-12 ">₹{{ json_decode($json_PayCheck)->TOTAL_FIXED_GROSS }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex align-items-center  justify-content-between mb-3">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <p class="dropdown-item" href="#"><i
                                                class=" ri-calendar-2-line mx-2"></i>FY
                                            2022-23</p>
                                    </div>
                                    ...
                                    @foreach ($data as $d)
                                        <li>
                                            ...
                                            <div class="text h4  text-end">
                                                <a href="{{ url('pdfview/' . $selectedPaySlipMonth) }}"><i
                                                        class="text-orange fa fa-download"></i></a>
                                    @endforeach
                    ...
                    <div class="card-body">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active h6" id="nav-home-tab" data-bs-toggle="tab"
                                    data-bs-target="#declaration" type="button" role="tab" aria-controls="nav-home"
                                    aria-selected="true">Declaration</button>
                                <button class="nav-link h6" id="nav-profile-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-profile" type="button" role="tab"
                                    aria-controls="nav-profile" aria-selected="false">Previous Income</button>
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="declaration" role="tabpanel"
                                ...
                                <div class="declaration-tax  mb-n2">
                                    <div class="row">
                                        <div class="col-sm-4  col-xl-4 col-md-4 col-lg-4">
                                            <div class="card declaration-tax-card small-card-left-line">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-sm-12  col-xl-12 col-md-12 col-lg-12 ">
                                                            <div
                                                                ...
                                                                <h5 class="mb-0">INR 4,66,888</h5>
                                                            </div>
                                                        </div>
                                                        <div
                                                            class="col-sm-12  col-xl-12 col-md-12 col-lg-12 text-right mt-n2">
                                                            <span class="text-muted f-10">Income Tax Computation</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tax-deduction-wrapper ">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6  col-xl-3 col-md-4 col-lg-3">
                                            <div class="card declaration-tax-card mini-card-left-line">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-sm-12  col-xl-12 col-md-12 col-lg-12">
                                                            <div
                                ...
                                <div class="other-card-container">
                                    ...
                                    <div class="title">
                                        <h6 class="mb-n1">Other Exemptions</h6>
