                ...
                <h5 class="dashboard-card-header fw-bold">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="icon dashboard-icon">
                            ...
                            <circle transform="rotate(-42.674 319.683 296.455)" fill="#1574FF" cx="319.7" cy="296.5"
                                r="29.7"></circle>
                            <circle transform="rotate(-42.674 192.306 207.13)" fill="#1574FF" cx="192.3" cy="207.1"
                                r="29.7"></circle>
                            <path fill="#333"
            ...
            <div class="deduction-summary-card dashboard-card">
                <h5 class="dashboard-card-header">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="icon dashboard-icon">
                        ...
                        <circle transform="rotate(-9.213 368.327 205.775)" fill="#1574FF" cx="368.3" cy="205.8" r="21">
                        </circle>
                        <path fill="#1574FF"
