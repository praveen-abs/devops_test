                        ...
                        <div class="col-md-9">
                            <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                ...
                                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                    <div class="d-flex mb-2">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('assets/images/small/img-6.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                    <div class="d-flex mb-2">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('assets/images/small/img-7.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content text-muted">
                        <div class="tab-pane active" id="home2" role="tabpanel">
                            <p class="flex-grow-1 mb-0"><img src="{{ URL::asset('assets/images/users/avatar-2.jpg') }}" alt="" class="avatar-lg rounded float-start me-3">
                        ...
                        <div class="col-lg-9">
                            <div class="tab-content text-muted mt-3 mt-lg-0">
                                ...
                                <div class="tab-pane fade" id="custom-v-pills-profile" role="tabpanel" aria-labelledby="custom-v-pills-profile-tab">
                                    <div class="d-flex mb-4">
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('assets/images/small/img-3.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <div class="tab-pane fade" id="custom-v-pills-messages" role="tabpanel" aria-labelledby="custom-v-pills-messages-tab">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0">
                                            <img src="{{ URL::asset('assets/images/small/img-8.jpg') }}" alt="" width="150" class="rounded">
                                        </div>
                                    </div>
                                </div><!--end tab-pane-->
                            </div>
