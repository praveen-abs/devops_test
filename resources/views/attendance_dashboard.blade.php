    ...
    <div class="card flex-fill project-wrapper">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-8">
                    <ul class="nav nav-pills nav-tabs-dashed">
                        <li class="nav-item text-muted">
                            <a class="nav-link active" data-bs-toggle="tab" href="#tab1">&nbsp;Attendance
                                Summary&nbsp;&nbsp;</a>
                        </li>
                        <li class="nav-item text-muted">
                            <a class="nav-link" data-bs-toggle="tab" href="#tab2">&nbsp;Attendance
                                Analytics&nbsp;&nbsp;</a>
                        </li>
                        <li class="nav-item text-muted">
                ...
                <div class="col-2 pt-2 text-md-end text-center">
                ...
                <div class="col-2 pt-2 text-md-start text-center">
                    <button type="button" class="btn btn-primary">
                        Employee Percentage
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-chevron-down" viewBox="0 0 16 16">
                                    ...
                                    <div class="col-sm-3 d-flex col-xl-3 col-md-3 col-lg-3">
                                        <div class="card shadow profile-box card-top-border">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted f-12">%age of employees that were present during the
                                                    selected duration</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 d-flex col-xl-3 col-md-3 col-lg-3">
                                        <div class="card shadow left-line">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted f-12">Avg. effective hours spent by employees during
                                    ...
                                    <div class="col-sm-3 d-flex col-xl-3 col-md-3 col-lg-3">
                                        <div class="card shadow left-line">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted f-12">Avg. OT hours worked by employees during the
                                                    selected duration</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 d-flex col-xl-3 col-md-3 col-lg-3">
                                        <div class="card shadow left-line">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted f-12">Total penalizations due to attendance
                                                    discrepancies during selected period</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <ul class="nav nav-pills nav-tabs-dashed card-header-tabs">
                                        <li class="nav-item text-muted">
                                            <button type="button" class="btn nav-link attendances-analyist-tab active"
                                                data-bs-toggle="tab" href="#tab1">Most hour worked</button>
                                        </li>
                                        <li class="nav-item text-muted">
                                            <button type="button"
                                                class="btn nav-link attendances-analyist-tab margin-left-mainases"
                                                data-bs-toggle="tab" href="#tab2">Overtime Hours</button>
                                        </li>
                                        <li class="nav-item text-muted">
                                            <button type="button"
                                                class="btn nav-link attendances-analyist-tab margin-left-mainases "
                                                data-bs-toggle="tab" href="#tab3">Least Hours Worked
                                            </button>
                                        </li>
                                        <li class="nav-item text-muted">
                                            <button type="button"
                                                class="btn nav-link attendances-analyist-tab margin-left-mainases "
                                                data-bs-toggle="tab" href="#tab4">Most Breaks
                                                Taken</button>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <ul class="nav nav-pills nav-tabs-dashed card-header-tabs">
                                            <li class="nav-item text-muted">
                                                <button type="button"
                                                    ...
                                                    data-bs-toggle="tab" href="#">Employee Count</button>
                                            </li>
                                            <li class="nav-item text-muted">
                                                <button type="button" class="btn nav-link attendances-analyist-tab "
                                                    data-bs-toggle="tab" href="#">Employee Percentage</button>
                                            </li>
                                        ...
                                        <div class="card shadow profile-box card-top-border">
                                            <div class="card-body">
                                                <div class="text-center">
                                                    ...
                                                    <p class="text-muted f-12">%age of employees that were on leave during
                                                        the selected duration</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-3 col-xl-3 col-md-3 col-lg-3">
                                        <div class="card shadow left-line">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted f-12 fw-bold">Avg. Work Hours Spent</p>
                                                <p class="text-muted f-12">Avg. leave taken by an employee during the
                                                    selected duration.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3 col-xl-3 col-md-3 col-lg-3">
                                        <div class="card shadow left-line">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted f-12">Balance available with employee irrespective of
                                    ...
                                    <div class="col-sm-3 col-xl-3 col-md-3 col-lg-3">
                                        <div class="card shadow left-line">
                                            <div class="card-body text-center">
                                                ...
                                                <p class="text-muted f-12">Total leave applied for after the leave has been
                                                    consumed/taken.</p>
                                            </div>
                                        </div>
                                    </div>
