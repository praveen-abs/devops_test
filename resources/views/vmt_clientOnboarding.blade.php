                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <div class="floating">
                                        ...
                                        <input type="text" placeholder="Client Code" name="client_code" id="client_code"
                                            placeholder="Autogenerate from Company Legal Name"
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <div class="floating">
                                        ...
                                        <input type="text" placeholder="Legal Name of the Company" name="client_name"
                                            id="client_name" class="onboard-form form-control textbox" required />
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <div class="floating">
                                        ...
                                        <input type="email" placeholder="Authorized Person Contact Email"
                                            name="auth_person_email" class="onboard-form form-control textbox" required />
                                        <!-- <label for="" class="float-label">Authorized Person Contact Email</label> -->
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <div class="floating">
                                        ...
                                        <select placeholder="Product" name="product" id="product"
                                            ...
                                            <option value="" class="text-muted" hidden selected disabled>Select
                                                Product</option>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <div class="floating">
                                        ...
                                        <select placeholder="Subscription Type" name="subscription_type"
                                            id="subscription_type" class="form-select form-control" aria-label=""
                                            required>
                                            <option value="" disabled selected hidden>Select Subscription Type
                                            </option>
