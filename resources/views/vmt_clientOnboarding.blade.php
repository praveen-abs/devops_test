                            ...
                            <div class="row mt-1">
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <input type="text" placeholder="Client Code" name="client_code" id="client_code"
                                        placeholder="Autogenerate from Company Legal Name" class="onboard-form form-control"
                                        required readonly />
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    <!-- <label class="" for="client_name">Legal Name of the Company{!! required() !!}</label> -->
                                    <input type="text" placeholder="Legal Name of the Company" name="client_name"
                                        id="client_name" class="onboard-form form-control" required />
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <input type="text" max="9999-12-31" placeholder="Contract Start Date" name="csd"
                                        class="onboard-form form-control" onfocus="(this.type='date')" required />
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <input type="text" placeholder="Professional Tax Registration Number"
                                        name="professional_tax" class="onboard-form form-control" pattern="alp-num"
                                        required />
                            ...
                            <div class="row mt-1">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <input type="text" placeholder="Authorized Person Designation"
                                        name="auth_person_desig" class="onboard-form form-control" pattern="alpha"
                                        required />
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6 col-xl-3 col-lg-3 mb-2 dashBoard">
                                    ...
                                    <div class="addfiles form-control" data="#doc_uploads" id="doc_uploads_label"><span
                                            class="file_label">Documents
                                        </span></div>
                                    <input type="file" placeholder="Documents Upload" name="doc_uploads"
                                        id="doc_uploads" class="onboard-form form-control files" style="display:none;"
                                        required accept=".doc,.docx,.pdf,image/*" />
                                </div>
