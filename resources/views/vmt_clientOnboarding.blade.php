                    ...
                    <form id="form-1" enctype="multipart/form-data">
                        ...
                        <div class="card shadow  profile-box card-top-border">
                            <div class="card-body justify-content-center align-items-center mb-5">
                                <div class="form-card p-2">
                                    <div class="text-primary mt-2 header-card-text">
                        ...
                        <div class="card shadow  profile-box card-top-border ">
                            <div class="card-body justify-content-center align-items-center">
                                ...
                                <div class="form-card mb-4 p-2">
                                    <div class="text-primary mt-2  header-card-text">
                                        <h5>Authorized Details</h5>
                                    </div>
                                    <div class="row mt-1">
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-xl-3 col-lg-3 mt-2">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-xl-3 col-lg-3 mt-2">
                                            ...
                                            <input type="number" minlength="10" maxlength="10"
                                                ...
                                                name="auth_person_contact" class="onboard-form form-control" required />
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-6 col-xl-3 col-lg-3 mt-2">
                                        ...
                                        <div class="col-12 text-right">
                                            <button type="submit" class="bg-pink btn  action-button text-center"
