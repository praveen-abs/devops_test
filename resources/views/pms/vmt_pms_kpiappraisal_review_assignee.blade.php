                        ...
                        <div class="col-12 mt-3">
                            <form id="upload_form" enctype="multipart/form-data">
                                <div class="row pull-right mb-3">
                                    ...
                                    <div class="col">
                                        <a href="{{route('download.excelsheet.pmsv2.review.form', [$assignedGoals->vmt_pms_kpiform_assigned_id,'1', $assignedGoals->year .'-'. strtoupper($assignedGoals->assignment_period)])}}" class="btn btn-orange pull-right" id="download-excel">Download</a>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <span class="btn bg-transparent text-primary outline-none border-0 fw-bold f-12 more-less-btn" onclick="showOrHideDescription('{{$index}}')">More</span>
                                                @endif
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div>
                                                ...
                                                <span class="btn bg-transparent text-primary outline-none border-0 fw-bold f-12 " id onclick="showOrHideDescription('{{$index}}')">More</span>
                                                @endif
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                <textarea style="width: 100%;" name="assignee_kpi_review[{{$kpiRow->id}}]" data-index="{{$index}}" data-targetval="{{$kpiRow->target}}" data-kpiweightageval="{{$kpiRow->kpi_weightage}}" id="assignee_kpi_review{{$index}}" cols="40" rows="3" @if(is_numeric($kpiRow->target))  onkeypress='return (event.charCode >= 48 && event.charCode <= 57) || event.charCode == 46' class="calculateSelfKPIPercentage" placeholder="type numbers only" @else placeholder="type here" @endif>@if(isset(json_decode($assignedGoals->assignee_kpi_review,true)[$kpiRow->id])) {{json_decode($assignedGoals->assignee_kpi_review,true)[$kpiRow->id]}} @endif</textarea>
                                            </div>
                                            @else
                                            <div>
                                        ...
                                        <td>
                                            ...
                                            @if($assignedGoals->is_assignee_submitted == 0)
                                            <div>
                                                <textarea style="width: 100%;" rows="3" name="assignee_kpi_comments[{{$kpiRow->id}}]" id="assignee_kpi_comments{{$index}}" cols="40"  placeholder="type here">@if(isset(json_decode($assignedGoals->assignee_kpi_comments,true)[$kpiRow->id])) {{json_decode($assignedGoals->assignee_kpi_comments,true)[$kpiRow->id]}} @endif</textarea>
                                            </div>
                                            @else
