                    ...
                    <div class="card-body border-bottom">
                        <div>
                            ...
                            <ul class="list-unstyled mb-0">
                                ...
                                <li>
                                    <a class="d-flex py-1" data-bs-toggle="collapse" href="#filterlist-electronics"
                                        role="button" aria-expanded="false" aria-controls="filterlist-electronics">
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a class="d-flex py-1" data-bs-toggle="collapse" href="#filterlist-furniture"
                                        role="button" aria-expanded="false" aria-controls="filterlist-furniture">
                                        <div class="flex-grow-1">
                                ...
                                <li>
                                    <a class="d-flex py-1" data-bs-toggle="collapse" href="#filterlist-appliances"
                                        role="button" aria-expanded="false" aria-controls="filterlist-appliances">
                                        <div class="flex-grow-1">
                            ...
                            <div class="accordion-body text-body pt-0">
                                ...
                                <div class="d-flex flex-column gap-2 mt-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="productBrandRadio5"
                                            checked>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="productBrandRadio1"
                                            checked>
                        ...
                        <div id="flush-collapseDiscount" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body text-body pt-1">
                                <div class="d-flex flex-column gap-2">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="productdiscountRadio3"
                                            checked>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseRating" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body text-body">
                                <div class="d-flex flex-column gap-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="" id="productratingRadio4"
                                            checked>
