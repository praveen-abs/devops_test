        ...
        <tr class="header-row" aria-rowcount="">
            <td colspan="8" class="border-less p3" rowspan="">
                <div class="header-cotent">
                    ...
                    <p class="margin-0" style="font-size:18px;">Indchem Marketing
                        Agencies
                    </p>
            ...
            <td colspan="4" class="border-less p3">
                ...
                <div class="header-img txt-right " style="padding: ">

                    <img src="{{ URL::asset('assets/images/client_logos/vasa/logo_indchem.jpg') }}" class=""
                        alt="" style="height: 70px;width:250px;max-height:100%;">
                </div>
