                                ...
                                if (ajax_data_currentdate.isAbsent) {
                                    ...
                                    if (ajax_data_currentdate.isMIP) {
                                     ...
                                     if(ajax_data_currentdate.attendance_mode_checkin=="mobile" || ajax_data_currentdate.attendance_mode_checkout=="mobile" ){
                                        ...
                                        cell.innerHTML = " <div class='p-2 w-100 h-100'><p class='show_date w-full d-flex align-items-center justify-content-between' >" + date + "<span style='font-size:9px;' class='badge bg-dark rounded-pill ' title='Shift Details'>"+ ajax_data_currentdate.vmt_employee_workshift_id+"</span>"+
                                        ...
                                        cell.innerHTML = " <div class='p-2 w-100 h-100'><p class='show_date' >" + date  + "<span style='font-size:9px;' class='badge bg-dark rounded-pill ' title='Shift Details'>"+ ajax_data_currentdate.vmt_employee_workshift_id+"</span>"+
