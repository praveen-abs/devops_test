        ...
        <div class="modal-dialog modal-dialog-scrollable  modal-lg ">
            <div class="modal-content  top-line">
                <div class="modal-header  border-0  py-2">
                    ...
                    <button type="button" class=" modal-close outline-none rounded-circle border-0" data-bs-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <div class="mb-2 floating-label">
                                <label for="" class="  float-label">Supplier id<span class="text-danger">*</span></label>
                                <input type="text" class="form-control textbox " id="" placeholder="Product ID">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <div class="mb-2 floating-label">
                                ...
                                <input type="text" class="form-control textbox" id="" placeholder="Product Name">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                            <div class="mb-2 floating-label">
                                <label for="" class="  float-label">Inward Quantity<span class="text-danger">*</span></label>
                                <input type="text" class="form-control textbox" id="lead-name" placeholder="Inward Quantity">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="mb-2 floating-label">
                                ...
                                <input type="text" class="form-control textbox" id="position" placeholder="Outward Quantity">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                            <div class="mb-2 floating-label">
                                ...
                                <input type="text" class="form-control textbox" id="lead-email" placeholder="Stock in Quantity">
