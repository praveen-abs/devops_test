		...
		<table class="c41">
			<tr class="c42">
				<td class="c50" colspan="9" rowspan="1">
					<p class="c0">
						...
						<span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 190.00px; height: 53.27px;">
							<img alt="Logo Description automatically generated" src="{{URL::asset('assets/images/images/image2.png')}}" style="width: 206.86px; height: 116.37px; margin-left: -8.82px; margin-top: -32.91px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title="">
						</span>
					</p>
					<p class="c23 c60"><span class="c43"></span></p>
					<p class="c0"><span class="c34">&ldquo;SHALOM BUILDING&rdquo; </span></p><p class="c0"><span class="c53">1</span><span class="c53 c61">st</span><span class="c53 c59">&nbsp;Floor, Office No.20, No.04, Mannar Street, </span></p>
			...
			<tr class="c10">
				<td class="c50 c24" colspan="9" rowspan="1">
					<p class="c3"><span class="c1">PAYSLIP FOR THE MONTH OF &ndash; APRIL &ndash; 2022</span></p>
				</td>
			</tr>
			<tr class="c10">
			...
			<tr class="c10">
				<td class="c22 c24" colspan="3" rowspan="1"><p class="c0"><span class="c2">EPF NUMBER</span></p></td>
				<td class="c22" colspan="2" rowspan="1"><p class="c3"><span class="c16">{{$employee->EPF_Number}}</span></p></td>
				<td class="c22 c24" colspan="2" rowspan="1"><p class="c0"><span class="c1">ESIC NUMBER</span></p></td>
				<td class="c22" colspan="2" rowspan="1"><p class="c3"><span class="c9">{{$employee->ESIC_Number}}</span></p></td>
			</tr>
			<tr class="c10">
				<td class="c22 c24" colspan="3" rowspan="1">
			...
			<tr class="c10">
				...
				<td class="c29" colspan="3" rowspan="1">
					<p class="c14"><span class="c9">&#8377; {{$employee->BASIC}}</span></p>
				</td>
				<td class="c17" colspan="1" rowspan="1">
					<p class="c14">
						<span class="c11">&#8377; </span>
				...
				<td class="c17" colspan="1" rowspan="1"><p class="c14"><span class="c11">&#8377; </span><span class="c16">4560</span></p></td><td class="c17" colspan="2" rowspan="1"><p class="c0"><span class="c1">EPF</span></p></td><td class="c17" colspan="1" rowspan="1"><p class="c14"><span class="c9">&#8377; 638</span></p></td></tr><tr class="c10">
					<td class="c17" colspan="1" rowspan="1">
						<p class="c0"><span class="c2">HRA</span></p>
					</td>
					<td class="c29" colspan="3" rowspan="1">
						<p class="c14"><span class="c9">&#8377; {{$employee->HRA}}</span></p>
					</td>
					<td class="c17" colspan="1" rowspan="1">
						<p class="c14">
							<span class="c11">&#8377; </span>
					...
					<td class="c17" colspan="2" rowspan="1"><p class="c0"><span class="c1">ESIC</span></p></td><td class="c17" colspan="1" rowspan="1"><p class="c14"><span class="c9">&#8377; 58</span></p></td></tr><tr class="c10">
						<td class="c17" colspan="1" rowspan="1">
							<p class="c0"><span class="c2">SPECIAL ALLOW</span></p>
						</td>
						<td class="c29" colspan="3" rowspan="1">
							<p class="c14"><span class="c9">&#8377; {{$employee->SPL_ALW}}</span></p>
						</td>
						<td class="c17" colspan="1" rowspan="1">
							<p class="c14"><span class="c11">&#8377; 0</span></p>
						</td>
						<td class="c17" colspan="1" rowspan="1">
							<p class="c14"><span class="c11">&#8377; 760</span></p>
						</td>
						<td class="c17" colspan="2" rowspan="1">
							<p class="c0"><span class="c1">PT</span></p>
						</td>
						<td class="c17" colspan="1" rowspan="1">
							<p class="c14"><span class="c9">&#8377; 115</span></p>
						</td>
					</tr>
					<tr class="c10">
						<td class="c17" colspan="1" rowspan="1">
					...
					<td class="c17" colspan="1" rowspan="1">
						<p class="c14"><span class="c9">&#8377; {{$employee->TDS}}</span></p>
					</td>
			</tr>
			<tr class="c10">
				<td class="c17" colspan="1" rowspan="1">
				...
				<td class="c17" colspan="1" rowspan="1">
					<p class="c14 c23"><span class="c16"></span></p></td>
				<td class="c17" colspan="1" rowspan="1">
					<p class="c14 c23"><span class="c16"></span></p>
				</td>
				<td class="c17" colspan="2" rowspan="1">
				...
				<td class="c17" colspan="1" rowspan="1">
					<p class="c14"><span class="c9">&#8377; {{$employee->CANTEEN_DEDN}}</span></p>
				</td>
			</tr>
			<tr class="c10">
				<td class="c17" colspan="1" rowspan="1">
				...
				<td class="c17" colspan="1" rowspan="1">
					<p class="c14"><span class="c9">&#8377; {{$employee->SAL_ADV}}</span></p>
				</td>
			</tr>
			<tr class="c10">
				<td class="c17" colspan="1" rowspan="1">
				...
				<td class="c17" colspan="1" rowspan="1">
					<p class="c14"><span class="c9">&#8377; 0</span></p>
				</td>
			</tr>
			<tr class="c10">
				<td class="c8" colspan="1" rowspan="1">
				...
				<td class="c20" colspan="3" rowspan="1">
					<p class="c14"><span class="c11">&#8377; </span><span class="c2">{{$employee->TOTAL_EARNED_GROSS}}</span></p>
				</td>
				<td class="c8" colspan="1" rowspan="1">
					<p class="c14 c23"><span class="c1"></span></p>
				</td>
				<td class="c8" colspan="1" rowspan="1">
					<p class="c14"><span class="c11">&#8377; </span><span class="c1">7666</span></p>
				</td>
				<td class="c8" colspan="2" rowspan="1">
					<p class="c0"><span class="c1">TOTAL DEDUCTION</span></p>
				</td>
				<td class="c8" colspan="1" rowspan="1">
					<p class="c14"><span class="c11">&#8377; </span><span class="c2">{{$employee->TOTAL_DEDUCTIONS}}</span></p>
				</td>
			</tr>
			<tr class="c49">
			...
			<tr class="c10"><td class="c33" colspan="2" rowspan="1"><p class="c0"><span class="c2">NET PAY IN WORDS</span></p></td><td class="c62" colspan="7" rowspan="1"><p class="c3"><span class="c1">{{$employee->Rupees}}</span></p></td></tr><tr class="c49"><td class="c47" colspan="9" rowspan="1"><p class="c3"><span class="c16">&nbsp;</span></p></td></tr><tr class="c10"><td class="c22 c24" colspan="3" rowspan="1"><p class="c3"><span class="c2">TRANSACTION ID</span></p></td><td class="c22" colspan="2" rowspan="1"><p class="c3 c23"><span class="c16"></span></p></td><td class="c22 c24" colspan="2" rowspan="1"><p class="c3"><span class="c1">Paid Date</span></p></td><td class="c22" colspan="2" rowspan="1"><p class="c3"><span class="c9">11-MAY-2022</span></p></td></tr><tr class="c49"><td class="c47" colspan="9" rowspan="1"><p class="c3"><span class="c16">&nbsp;</span></p></td></tr><tr class="c58"><td class="c50" colspan="9" rowspan="1"><p class="c3"><span class="c31">This is a computer-generated slip does not require signature</span></p></td></tr></table>
					...
					<p class="c14 c56">
						<span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 830.67px; height: 82.67px;">
							<img alt="" src="{{URL::asset('assets/images/images/image4.png')}}" style="width: 830.67px; height: 82.67px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title="" />
						</span>
						<span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 830.67px; height: 80.67px;">
							<img alt="" src="{{URL::asset('assets/images/images/image3.png')}}" style="width: 830.67px; height: 80.67px; margin-left: 0.00px; margin-top: 0.00px; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px);" title="" />
						</span>
					</p>
						...
						<p class="c0">
							...
							<span style="overflow: hidden; display: inline-block; margin: 0.00px 0.00px; border: 0.00px solid #000000; transform: rotate(0.00rad) translateZ(0px); -webkit-transform: rotate(0.00rad) translateZ(0px); width: 150.13px; height: 28.00px;">
								<img 
									...
									src="{{URL::asset('assets/images/images/image1.png')}}" 
