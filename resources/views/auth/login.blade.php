        ...
        <div class="row h-100">
            <div class="col-md-6 col-lg-6 col-xl-6 d-flex h-100 align-items-center justify-content-center left-content">
                <div class="login-left-content w-100 h-100 py-3 d-flex justify-content-center">
                    <div id="login-carousel" class="carousel w-100 slide" data-ride="carousel">
                        <div class="carousel-inner h-100">
                            <div class="carousel-item active h-100">

                                <img src="{{ URL::asset('assets/images/login_img/illustrator.svg') }}" width="500" height="550"
                                    alt="" class="">
                            ...
                            <div class="carousel-item  h-100">
                                <img src="{{ URL::asset('assets/images/login_img/Chat support.svg') }}" width="500" height="550"
                                    alt="" class="">
                            ...
                            <div class="carousel-item h-100">
                                <img src="{{ URL::asset('assets/images/login_img/Payroll.svg') }}" width="500" height="550" alt=""
                                    class="">
                                <div class="carousel-caption d-none d-md-block">
                            ...
                            <div class="carousel-item h-100">
                                <img src="{{ URL::asset('assets/images/login_img/Certified.svg') }}" width="500" height="550"
                                    alt="" class="">
                                <div class="carousel-caption d-none d-md-block">
                                    <p><span class="text-danger">Quality</span> and <span  class="text-danger">Information</span> Security Management
                                    </p>
                                </div>
                            </div>
                        </div>
