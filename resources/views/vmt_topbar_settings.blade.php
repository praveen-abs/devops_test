        ...
        <div class="row w-100">
                ...
                <div class="left-content  d-flex">
                    <div class="card ">
                        <div class="card-body p-0">
                            <div class="nav list-group flex-column " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <a href="#v-general" class="nav-link list-group-item flex-column d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                ...
                                <a href="#v-company" class="nav-link flex-column list-group-item  d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
                                        Company Info </label>
                                    <span> Information about Company </span>
                                </a>

                                <a href="#v-welcome" class="nav-link flex-column list-group-item  d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
                                        Welcome Screen </label>
                                    <span> Welcome screen settings </span>
                                </a>
                                <a href="#v-roll" class="nav-link flex-column list-group-item d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
            ...
            <div class="col-md-8 col-xl-8 col-lg-8 ">
                <div class=" tab-content right-content p-0 mx-1 container-fluid" id="v-pills-tabContent">
                    <!-- general info -->
                    <div class=" p-0  tab-pane fade show active" id="v-general" role="tabpanel" aria-labelledby="v-pills-home-tab">
                ...
                <img src="{{request()->getSchemeAndHttpHost()."".$general_info->logo_img}}" >
                                    ...
                                    <div class="d-flex align-items-center mb-4 justify-content-between">
                                        ...
                                        <div class="d-flex w-50 align-items-center w-75  justify-content-end ">
                                            <div class="input-search align-self-center w-50">
                                                ...
                                                <input type="text" placeholder="Search Roles" autocomplete="off" class="search-bar border-none rounded-pill outline-none "><span class="ic-search icon"></span>

                                            </div>
                                            <button class="btn btn-primary mx-2" data-bs-toggle="modal" data-bs-target="#rollModal">New Role</button>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p> Asset Manager <span><a class="icon-click"><span class="ri-pencil-line"></span></a></span>
                                                            ...
                                                            <div class="">
                                                                <div class="chip-wrapper b-0 p-0">
                                                                    <div class="chips d-flex m-2">
                                                                        <div class="employee-profile-header  d-flex align-items-center justify-content-center">
                    ...
                    <div class="p-0   tab-pane fade show " id="v-company" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                ...
                                <div class="form-card">
                                    <div class="row mt-1">
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            ...
                                            <div class="floating">
                                                <input type="text" placeholder="Employee Code" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="EPF Registration Number" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="ESIC Registration Number" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="LWF Registration Number" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="Professional Tax Registration Number" name="employee_code" class="onboard-form form-control textbox" required />
                                ...
                                <div class="form-card">
                                    <div class="row mt-1">
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="Authorized Person Name" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="Authorized Person Designation" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="Authorized Person Contact Number" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="Authorized Person Contact Email" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="Billing Address" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="text" placeholder="Shipping Address" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            <!-- <label class="" for="employee_code">Employee Code{!! required() !!}</label> -->
                                            <div class="floating">
                                                <input type="file" placeholder="" name="employee_code" class="onboard-form form-control textbox" required />
                                        ...
                                        <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 col-xl-6 mb-3">
                                            ...
                                            <div class="floating">
                                                <select class="form-select textbox" aria-label="">
                                                    <option value="Select Subscription Type" show disabled readonly>Select Subscription Type>
                                                    </option>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 col-xl-12 mb-3 text-end">
                                            <button type="submit" class="btn btn-primary  action-button text-center" value="Submit">Submit</button>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="d-flex">
                                            <div class="chip-wrapper  p-0">
                                                ...
                                                <input class="form-control Search-Employee" aria-expanded="false" aria-autocomplete="list" placeholder="Search Employee">
                                    ...
                                    <div class="mb-4 ">
                                        <div class=" mt-4 buttons-container d-flex align-items-center">
                                            <button class="btn btn-default mx-2">Preview</button><button class="btn btn-primary">Save</button>
                                        </div>
                ...
                <div class="modal fade p-2" id="rollModal">
                    <div class="modal-dialog modal-lg " id="" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
                                ...
                                <div class="settings-contents container-fluid">
                                    ...
                                    <div class="mb-3 ">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div class="col-6">
                                                <div class="input-search align-self-center"><input type="text" placeholder="Search Roles" autocomplete="off" class="form-control w-100 "><span class="ic-search icon"></span>
                                        ...
                                        <div class="container-fluid p-0 d-flex">
                                            ...
                                            <div class="left-content-settings">
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body p-0">
                                                        <div class="nav list-group" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                            <a href="#v-pills-assest" class="nav-link active list-group-item flex-column d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                                                <label>Assets</label>
                                                                <span> </span>
                                                            </a>
                                                            ...
                                                            <a href="#v-pills-attendance" class="nav-link list-group-item flex-column d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true">
                                                                <label>Attendance</label>
                                                                <span> </span>
                                                            </a>
                                                            <a href="#v-pills-document" class="nav-link flex-column list-group-item  d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
                                                                    Documents</label>
                                                                <span></span>
                                                            </a>
                                                            <a href="#v-pills-finance" class="nav-link flex-column list-group-item d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
                                                                    Employee Finance</label>
                                                                <span>
                                                                </span></a>
                                                            <a href="#v-pills-engage" class="nav-link flex-column list-group-item d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
                                                                    Engage </label><span>
                                                                </span></a>
                                                            <a href="#v-pills-expenses" class="nav-link flex-column list-group-item d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
                                                                    Expenses </label><span> </span></a>
                                                            <a href="#v-pills-helpdesk" class="nav-link flex-column list-group-item d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
                                                                    Helpdesk </label><span> </span></a>
                                                            <a href="#v-pills-hris" class="nav-link flex-column list-group-item d-flex" id="v-pills-home-tab" data-bs-toggle="pill" role="tab" aria-controls="v-pills-home" aria-selected="true"><label>
                                            ...
                                            <div class="right-content-settings mt-0 mx-5 d-flex">
                                                ...
                                                <div class="tab-content" id="v-pills-tabContent ">
                                                    <!-- assest -->
                                                    <div class="">
                                                        <div class="tab-pane active assest fade show" id="v-pills-assest" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                    ...
                                                    <div class="tab-pane fade " id="v-pills-attendance" role="tabpanel">
                                                        <div class="list-group assest ">
                                                            <label class="list-group-item fw-bold">
                                                                <input class="form-check-input me-1 fw-bold" type="checkbox" value="">
                                                    ...
                                                    <!-- documents -->
                                                    <div class="tab-pane active fade " id="v-pills-document" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                        <div class="list-group assest ">
                                                    ...
                                                    <div class="tab-pane active fade " id="v-pills-finance" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                        <div class="list-group assest ">
                                                            <label class="list-group-item fw-bold px-2 py-3">
                                                                <input class="form-check-input me-1 fw-bold" type="checkbox" value="">
                                                    ...
                                                    <!-- Engage -->
                                                    <div class="tab-pane  fade " id="v-pills-engage" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                        <div class="list-group assest ">
                                                            <label class="list-group-item fw-bold px-2 py-3">
                                                                <input class="form-check-input me-1 fw-bold" type="checkbox" value="">
                                                    ...
                                                    <!-- expenses -->
                                                    <div class="tab-pane  fade " id="v-pills-expenses" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                        <div class="list-group assest ">
                                                            <label class="list-group-item fw-bold px-2 py-3">
                                                                <input class="form-check-input me-1 fw-bold" type="checkbox" value="">
                                                                Expense Privileges
                                                    ...
                                                    <div class="tab-pane  fade " id="v-pills-helpdesk" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                        <div class="list-group assest ">
                                                            <label class="list-group-item fw-bold px-2 py-3">
                                                                <input class="form-check-input me-1 fw-bold" type="checkbox" value="">
                                                                Helpdesk Privileges
                                                    ...
                                                    <div class="tab-pane  fade " id="v-pills-hris" role="tabpanel" aria-labelledby="v-pills-home-tab">
                                                        <div class="list-group assest ">
                                                            <label class="list-group-item fw-bold px-2 py-3">
                                                                <input class="form-check-input me-1 fw-bold" type="checkbox" value="">
                                                                Core HR Privileges
