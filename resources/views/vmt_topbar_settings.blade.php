...
<div class="settings-layout p-0 d-flex justify-content-start container-fluid ">
    ...
    <div id="borderedToast2" class="toast toast-border-success overflow-hidden mt-3" role="alert" aria-live="assertive" aria-atomic="true" >
        ...
        <div class="container p-0   tab-pane fade show " id="v-roll" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        ...
                        <div class="d-flex align-items-center  justify-content-between">
                            ...
                            <div class="d-flex w-50 align-items-center w-75  justify-content-end ">
                                <div class="input-search align-self-center w-50"><input type="text"
                                        placeholder="Search Roles" autocomplete="off" class="form-control w-100 "><span
                                        ...
                                        <td>
                                            <div>
                                                <div class="row align-items-center  mb-4">
                                                    <p class="col-sm-3">Across all employees</p>
                                                    <div class="col-sm-8 pl-16">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="welcome-container  w-50 d-flex align-items-center">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <div class="container-fluid d-flex">
                                ...
                                <div class="card " style="width: 18rem;">
                                    ...
                                    <div class="card-body p-0">
                                        <div class="nav list-group" id="v-pills-tab" role="tablist"
                                            ...
                                            <a href="#v-pills-hris" class="nav-link flex-column list-group-item d-flex"
                                                id="v-pills-home-tab" data-bs-toggle="pill" role="tab"
                                                aria-controls="v-pills-home" aria-selected="true"><label>
                            ...
                            <div class="right-content mx-5 d-flex">

                                <div class="tab-content" id="v-pills-tabContent ">
                                    <!-- assest -->
                                    <div class="tab-pane active fade show" id="v-pills-assest" role="tabpanel"
                                        aria-labelledby="v-pills-home-tab">
