                      ...
                      <td>
                        <table style="width: 100%; border-radius: 12px; background-color: #fff; padding-left: 32px; padding-right: 32px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)" cellpadding="0" cellspacing="0" role="none">
                          ...
                          <tr>
                            <td style="width: 100%;">
                              <p class="sm-text-sm" style="margin: 0 0 16px; text-align: justify; font-size: 14px; color: #334155">
                                If you have any questions or concerns, don’t hesitate to reach out to your reporting manager or the HR team. Kindly visit the HRMS portal for more details.
                              </p>
                            </td>
                          </tr>
                          <tr>
                            <td style="text-align: center;">
                              <a href="{{ $loginLink }}/team-appraisal" class="hover-bg-red-700 sm-mx-3" style="margin-left: 48px; margin-right: 48px; border-radius: 9999px; background-color: #ef4444; padding: 8px 16px; font-size: 14px; font-weight: 600; color: #fff; text-decoration: none">
                          ...
                          <tr>
                            <td style="width: 100%;">
                              <a href="{{ $loginLink }}"><p class="sm-text-sm" style="margin: 0 0 16px; text-align: center; font-size: 14px; color: #3b82f6">
