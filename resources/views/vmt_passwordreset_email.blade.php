                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                      ...
                                      <p class="text-start ">Please click the below link to reset your password</p>


                                        <a href="{{$passwordResetLink}}" style="background:blue;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;" type="submit">Reset Password</a>
                                        <p class="text-start ">Note :  The above link valid for 30 minutes only</p>
