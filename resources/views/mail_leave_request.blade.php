              ...
              <tr>
                <td class="sm-py-3 sm-px-2" style="padding: 12px">
                  <table class="sm-w-full" style="margin-left: auto; margin-right: auto; margin-top: 16px; width: 500px" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                      <td>
                        <img src="../images/ABSHrmsLogo.png" width="100" alt style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0; float: left">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Amazon_logo.svg/1280px-Amazon_logo.svg.png" width="100" alt style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0; float: right">
                      </td>
                    </tr>
                  </table>
                                ...
                                <tr>
                                  <td>
                                    <table align="center" style="width: 100%; padding: 4px; line-height: 4px" cellpadding="0" cellspacing="0" role="presentation">
                                      <tr>
                                        <td>
                                          <img src="https://static.vecteezy.com/system/resources/previews/006/988/723/original/boy-playing-game-gamer-logo-free-vector.jpg" alt style="max-width: 100%; vertical-align: middle; line-height: 1; border: 0; float: right; height: 64px; width: 64px; border-radius: 9999px; padding: 8px">
                                        </td>
