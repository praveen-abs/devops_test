    ...
    <div class="flex flex-row h-full" >
        ...
        <nav class="bg-gray-900  justify-between flex flex-col transition-all duration-700  overflow-hidden items-center"
                ...
                <div class="mt-10">
                    <ul>
                        ...
                        <li class="mb-6">
                            <a href="#">
                                <span>
                                    <svg class="fill-current h-5 w-5 mx-auto text-gray-300 hover:text-green-500"
                                        viewBox="0 0 24 24">
                        ...
                        <li class="mb-6">
                            <a href="#">
                                <span>
                                    <svg class="fill-current h-5 w-5 text-gray-300 mx-auto hover:text-green-500"
                                        viewBox="0 0 24 24">
            ...
            <div class="mb-4">
                <a href="#">
                    <span>
                        <svg class="fill-current h-5 w-5 text-gray-300 mx-auto hover:text-red-500" viewBox="0 0 24 24"
                            fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
