                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md  -6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <InputText class="form-onboard-form form-control  textbox  capitalize "
                                                        type="text" v-model="v$.EmployeeCode.$model"
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.PersonDetialsMaritalStatus.$invalid && submitted) || v$.PersonDetialsMaritalStatus.$pending.$response"
                                                        class="p-error">{{
                                                            v$.PersonDetialsMaritalStatus.required.$message.replace('Value',
                                                                'Marital Status') }}</span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.DateOfJoining.$invalid && submitted) || v$.DateOfJoining.$pending.$response"
                                                        class="p-error">{{
                                                            v$.DateOfJoining.required.$message.replace('Value',
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.PersonDetialsGender.$invalid && submitted) || v$.PersonDetialsGender.$pending.$response"
                                                        class="p-error">{{
                                                            v$.PersonDetialsGender.required.$message.replace('Value',
                                                                'Gender') }}</span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <span
                                                    v-if="(v$.PersonDetialsMobileNumber.$invalid && submitted) || v$.PersonDetialsMobileNumber.$pending.$response"
                                                    class="p-error">{{
                                                        v$.PersonDetialsMobileNumber.required.$message.replace('Value',
                                                            'Mobile Number') }}</span>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.PersonDetialsEmail.$invalid && submitted) || v$.PersonDetialsEmail.$pending.$response"
                                                        class="p-error">{{
                                                            v$.PersonDetialsEmail.required.$message.replace('Value',
                                                                'Email') }}</span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        ...
                                                        class="p-error">{{
                                                            v$.AadhaarNumber.required.$message.replace('Value',
                                                                'Aadhaar Number') }}</span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <InputText class="onboard-form form-control textbox " type="text"
                                                        v-model="v$.DLNumber.$model" placeholder="DL Number" minlength="16"
                                                        maxlength="16" />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.ChooseNationality.$invalid && submitted) || v$.ChooseNationality.$pending.$response"
                                                        class="p-error">{{
                                                            v$.ChooseNationality.required.$message.replace('Value',
                                                                'Choose Nationality') }}</span>

                                                </div>

                                            </div>
                                            <div v-if="NationalityData"
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <select v-model="v$.PersonDetialsBloodGroup.$model"
                                                        placeholder="Blood Group" name="blood_group"
                                                        class="onboard-form form-control textbox  ">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                ...
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.BankName.$invalid && submitted) || v$.BankName.$pending.$response"
                                                        class="p-error">{{ v$.BankName.required.$message.replace('Value',
                                                            'BankName ') }}</span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <InputText placeholder="Account Number" minlength="10"
                                                        ...
                                                        maxlength="18" class="onboard-form form-control textbox" type="text"
                                                        v-model="v$.AccountNumber.$model" />

                                                    <span
                                                        v-if="(v$.AccountNumber.$invalid && submitted) || v$.AccountNumber.$pending.$response"
                                                        class="p-error">{{
                                                            v$.AccountNumber.required.$message.replace('Value',
                                                                'Account Number') }}</span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <InputText type="text" v-model="v$.BankIFSCCode.$model"
                                                        ...
                                                        class=" form-control textbox " pattern="^[A-Z]{4}0[A-Z0-9]{6}$"
                                                        minlength="11" maxlength="12" placeholder="Bank IFSC Code" />

                                                    <span
                                                        v-if="(v$.BankIFSCCode.$invalid && submitted) || v$.BankIFSCCode.$pending.$response"
                                                        class="p-error">{{
                                                            v$.BankIFSCCode.required.$message.replace('Value',
                                                                'Bank IFSC Code') }}</span>
                                                ...
                                                <div class="row mt-1">
                                                    <div class="col-md-6 col-sm-12 col-xs-6 col-lg-6 col-xxl-6 mb-2">
                                                        <div class="floating">
                                                            ...
                                                            <Textarea placeholder="Permanent Address"
                                                                ...
                                                                style="height: 100px;" type="text" rows="3"
                                                                id="permanent_address_line_1"
                                                                :class="{ 'p-invalid': v$.PermanentAddress1.$invalid && submitted }"
                                                                v-model="v$.PermanentAddress1.$model" />
                                                            <span
                                                                v-if="(v$.PermanentAddress1.$invalid && submitted) || v$.PermanentAddress1.$pending.$response"
                                                                class="p-error">{{
                                                                    v$.PermanentAddress1.required.$message.replace('Value',
                                                                        'PermanentAddress1') }}</span>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-6 col-lg-6 col-xxl-6 mb-2">
                                                        <div class="floating">
                                                            ...
                                                            <span
                                                                v-if="(v$.PermanentAddress2.$invalid && submitted) || v$.PermanentAddress2.$pending.$response"
                                                                class="p-error">{{
                                                                    v$.PermanentAddress2.required.$message.replace('Value',
                                                                        'PermanentAddress2') }}</span>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                        ...
                                                        <div class="floating">
                                                            ...
                                                            <span
                                                                v-if="(v$.Permanentcountry.$invalid && submitted) || v$.Permanentcountry.$pending.$response"
                                                                class="p-error">{{
                                                                    v$.Permanentcountry.required.$message.replace('Value',
                                                                        'country') }}</span>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                        <div class="floating">
                                                            ...
                                                            <span
                                                                v-if="(v$.Permanentstate.$invalid && submitted) || v$.Permanentstate.$pending.$response"
                                                                class="p-error">{{
                                                                    v$.Permanentstate.required.$message.replace('Value',
                                                                        'State') }}</span>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                        <div class="floating">
                                                            ...
                                                            <span
                                                                v-if="(v$.PermanentCity.$invalid && submitted) || v$.PermanentCity.$pending.$response"
                                                                class="p-error">{{
                                                                    v$.PermanentCity.required.$message.replace('Value',
                                                                        'City') }}</span>
                                                    ...
                                                    <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                        <div class="floating">
                                                            ...
                                                            <InputText class="onboard-form form-control textbox  capitalize"
                                                                ...
                                                                placeholder="Pincode" />
                                                            <span
                                                                v-if="(v$.PermanentPincode.$invalid && submitted) || v$.PermanentPincode.$pending.$response"
                                                                class="p-error">{{
                                                                    v$.PermanentPincode.required.$message.replace('Value',
                                                                        'Pincode') }}</span>
                                        ...
                                        <div class="row mt-1">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 col-xxl-3 mb-2">
                                                <div class="floating">
                                                    <label for="" class="float-label">Process<span
                                                            class="text-danger">*</span></label>
                                                    <InputText class="onboard-form form-control " type="text"
                                                        :class="{ 'p-invalid': v$.Process.$invalid && submitted }"
                                                        v-model="v$.Process.$model" placeholder="Process" />

                                                    <span
                                                        v-if="(v$.Process.$invalid && submitted) || v$.Process.$pending.$response"
                                                        class="p-error">{{ v$.Process.required.$message.replace('Value',
                                                            'Process') }}</span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 col-xxl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.Designation.$invalid && submitted) || v$.Designation.$pending.$response"
                                                        class="p-error">{{ v$.Designation.required.$message.replace('Value',
                                                            'Designation') }}
                                                    </span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <input type="number" placeholder="Cost Center"
                                                        v-model="v$.CostCenter.$model" name="cost_center"
                                                        class="onboard-form form-control textbox " />
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2 col-xxl-3">
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.ReportingManagerCode.$invalid && submitted) || v$.ReportingManagerCode.$pending.$response"
                                                        class="p-error">{{ v$.ReportingManagerCode.required.$message.replace('Value',
...
<!-- 
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <input type="text" minlength="10" maxlength="10"
                                                        v-model="v$.OfficialMobileNO.$model" placeholder="Official Mobile"
                                                        name="official_mobile" id="official_mobile"
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <input type="number" placeholder="Employee Notice Period Days"
                                                        v-model="v$.EmployeeNoticePeriodDays.$model" name="emp_notice"
                                                        class="onboard-form form-control textbox " />
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <span
                                                        v-if="(v$.DateOfConfirmation.$invalid && submitted) || v$.DateOfConfirmation.$pending.$response"
                                                        class="p-error">{{
                                                            v$.DateOfConfirmation.required.$message.replace('Value',
                                                                'Date Of Confirmation') }}</span>
                                        ...
                                        <div class="row mt-1">
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <InputText class="nboard-form form-control textbox capitalize"
                                                        ...
                                                        <span
                                                        v-if="(v$.fatherName.$invalid && submitted) || v$.fatherName.$pending.$response"
                                                        class="p-error">{{ v$.fatherName.required.$message.replace('Value',
                                                            'father Name') }}
                                                      </span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <InputText class="onboard-form form-control textbox  " type="text"
                                                        placeholder="Date of Birth"  @change="fnCalculateAge"
                                                        :class="{ 'p-invalid': v$.fatherDateofBirth.$invalid && submitted }"
                                                        v-model="v$.fatherDateofBirth.$model" onfocus="(this.type='date')" />

                                                        <span
                                                        v-if="(v$.fatherDateofBirth.$invalid && submitted) || v$.fatherDateofBirth.$pending.$response"
                                                        class="p-error">{{ v$.fatherDateofBirth.required.$message.replace('Value',
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <InputText class="onboard-form form-control textbox  " type="text"
                                                        ...
                                                        <span
                                                        v-if="(v$.motherName.$invalid && submitted) || v$.motherName.$pending.$response"
                                                        class="p-error">{{ v$.motherName.required.$message.replace('Value',
                                                            'mother Name') }}
                                                      </span>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12 col-lg-3 col-xl-3 mb-2">
                                                <div class="floating">
                                                    ...
                                                    <InputText class="onboard-form form-control textbox  " type="text"
                                                        ...
                                                        v-model="v$.motherDateofBirth.$model"  @change="fnCalculateAge"
                                                        onfocus="(this.type='date')" />

                                                        <span
                                                        v-if="(v$.motherDateofBirth.$invalid && submitted) || v$.motherDateofBirth.$pending.$response"
                                                        class="p-error">{{ v$.motherDateofBirth.required.$message.replace('Value',
                                            ...
                                            <div v-if="sposeData"
                                                ...
                                                <div class="floating">
                                                    ...
                                                    <InputText v-if="sposeData" class="onboard-form form-control textbox  "
                                                        ...
                                                        <span
                                                        v-if="(v$.SpouseName.$invalid && submitted) || v$.SpouseName.$pending.$response"
                                                        class="p-error">{{ v$.SpouseName.required.$message.replace('Value',
                                                            'Spouse Name') }}
                                                      </span>
                                                </div>
                                            </div>
                                            <div v-if="sposeData"
                                                ...
                                                <div class="floating">
                                                    ...
                                                    <InputText class="onboard-form form-control textbox  " type="text"
                                                        ...
                                                        :class="{ 'is-invalid': v$.dateOfWedding.$invalid && submitted }"
                                                        v-model="v$.dateOfWedding.$model" onfocus="(this.type='date')" />

                                                        <span
                                                        v-if="(v$.dateOfWedding.$invalid && submitted) || v$.dateOfWedding.$pending.$response"
                                                        class="p-error">{{ v$.dateOfWedding.required.$message.replace('Value',
                                                            'Date Of Wedding') }}
                                                      </span>
                                                </div>
                                            </div>
                                            <div v-if="sposeData"
                                                ...
                                                <div class="floating">
                                                    ...
                                                    <select placeholder="Spouse Gender" name="spouse_gender"
                                                        v-model="v$.spouseGender.$model" id="spouse_gender"
                                                        :class="{ 'is-invalid': v$.SpouseDOB.$invalid && submitted }"
                                                        class="textbox  onboard-form form-control  ">
                                                        <option value="" hidden selected disabled>Select
                                                    ...
                                                    <span
                                                        v-if="(v$.spouseGender.$invalid && submitted) || v$.spouseGender.$pending.$response"
                                                        class="p-error">{{ v$.spouseGender.required.$message.replace('Value',
                                                            'Spouse Gender') }}
                                                      </span>
                                                </div>
                                            </div>
                                            <div v-if="sposeData"
                                                ...
                                                <div class="floating">
                                                    ...
                                                    <InputText class="onboard-form form-control textbox  " max="9999-12-31"
                                                        name="dob_spouse" id="dob_spouse" type="text"
                                                        placeholder="SpouseDOB"
                                                        :class="{ 'p-invalid': v$.SpouseDOB.$invalid && submitted }"
                                                        v-model="v$.SpouseDOB.$model" onfocus="(this.type='date')" />

                                                        <span
                                                        v-if="(v$.SpouseDOB.$invalid && submitted) || v$.SpouseDOB.$pending.$response"
                                                        class="p-error">{{ v$.SpouseDOB.required.$message.replace('Value',
                                    ...
                                    <div class="form-card mb-2">
                                        <div class="row mt-1">
                                            ...
                                            <!-- <div class="addfiles form-control" 
                                                ...
                                                <input v-if="AadharDocBackInvalid" type="file" accept="image/png, image/gif, image/jpeg" ref="AadharCardBack"
                                            ...
                                            <!-- <div class="addfiles form-control" data="#voters_id_file"
                                                ...
                                                <input type="file" accept="image/png, image/gif, image/jpeg" ref="VoterIdDoc"
                                                   ...
                                                   />
                                                    ...
                                                    <span v-if="VoterIdInvalid" class="p-error">Voter Id is Required</span>
                                            </div>
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 mb-2">
                                            ...
                                            <!-- <div class="addfiles form-control" data="#reliving_letter_file"
                                                ...
                                                <input type="file" accept="image/png, image/gif, image/jpeg"
                                                    ...
                                                    id="reliving_letter_file"  v-if="ReleivingLetterInvalid"
                                                    ...
                                                    <span v-if="ReleivingLetterInvalid" class="p-error">Releiving Letter is Required</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <Dialog v-if="!employee_onboarding.EmployeeNameasper.length > 0 && !employee_onboarding.AadhaarNumber.length > 0"
        ...
        <li
            v-if="employee_onboarding.PersonDetialsMobileNumber == '' || employee_onboarding.PersonDetialsMobileNumber.length < 0">
            Mobile Number Required</li>
    </Dialog>
...
const handleSubmit = (isFormValid) => {
    ...
    AadharCardBack.fileName == undefined ? AadharDocBackInvalid.value = true : AadharDocBackInvalid.value = false
    PanCardDoc.fileName == undefined ? PancardInvalid.value = true : PancardInvalid.value = false
    DrivingLicenseDoc.fileName == undefined ? DrivingLisenceInvalid.value = true : DrivingLisenceInvalid.value = false
    VoterIdDoc.fileName == undefined ? VoterIdInvalid.value = true : VoterIdInvalid.value = false
    ReleivingLetterDoc.fileName == undefined ? ReleivingLetterInvalid.value = true : ReleivingLetterInvalid.value = false
    EductionDoc.fileName == undefined ? EducationCertificateInvalid.value = true : EducationCertificateInvalid.value = false
    PassportDoc.fileName == undefined ? PassPortInvalid.value = true : PassPortInvalid.value = false
