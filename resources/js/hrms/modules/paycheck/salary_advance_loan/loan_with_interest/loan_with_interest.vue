        ...
        <div class="px-5 row d-flex justify-content-start align-items-center card-body">
            <div class="flex justify-between gap-6 my-2">
                <div class="max-[1300px]:w-[30%px] ">
                    <p class="text-[14px] font-medium">You are eligible for the Loan with Interest as per the
...
onMounted(() => {
    ...
    useEmpStore.getEligible_loan_and_advance('loan_with_int');
    useEmpStore.getEmployeeTotalvalue('loan_with_int');
