    ...
    <div>
        <div class="flex justify-between p-2 bg-white">
            ...
            <div class="flex items-center" >
                <button class=" p-2 mx-2 rounded-md w-[120px] " :class="[ !UseEmployeeMaster.employeeMaterReportSource.length == 0 ? 'bg-[#000] text-white':' !text-[#000] !bg-[#E6E6E6] ']" @click="UseEmployeeMaster.btn_download = !UseEmployeeMaster.btn_download,UseEmployeeMaster.downloadEmployeeMaster() ">
                        ...
                        <div id="btn-download"  style=" position: absolute; right: 0;"
                            ...
                            <svg width="22px" height="16px" viewBox="0 0 22 16" :class="[ !UseEmployeeMaster.employeeMaterReportSource.length == 0 ? '!stroke-[#ffff] ':'!stroke-[#000]']"  >
                                <path
                                    ...
                                    id="check" :style="[ !UseEmployeeMaster.employeeMaterReportSource.length === 0 ? 'stroke=blue' :'!bg-[#E6E6E6] !text-[#000] ']"></path>
                                <polyline points="4.5 8.5 8 11 11.5 8.5" class="svg-out"  ></polyline>
                                <path d="M8,1 L8,11" class="svg-out "  stroke="" :style="[UseEmployeeMaster.employeeMaterReportSource.length === 0 ?  'red' : 'fill: red']" ></path>
                            </svg>
                        </div>
                </button>
            </div>
        ...
        currentPageReportTemplate="{first} to {last} of {totalRecords}" >
            <Column class="" v-for="col of UseEmployeeMaster.Employee_MaterReportDynamicHeaders" :key="col.title" :field="col.title" :header="col.title"
