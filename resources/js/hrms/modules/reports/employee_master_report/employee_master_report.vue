    ...
    <div class="px-4">
        ...
        <div style="position: relative;">
            ...
            <div class="row flex w-[100%] ">
                <ul class="flex mb-3 divide-x col-4 nav nav-pills divide-solid nav-tabs-dashed max-[1024px]:w-[100%]"  id="pills-tab" role="tablist">
                    <li class=" nav-item" role="presentation">
                        <router-link to="" @click="activetab = 1" class=" text-center px-4  border-0 font-['poppins'] text-[14px] text-[#001820]" :class="[activetab === 1 ? 'active font-semibold ' : 'font-medium !text-[#8B8B8B]']">Employee Master </router-link>

                        <div v-if="activetab === 1" class=" h-1 rounded-l-3xl relative top-[0px]" style="border:2.2px solid #F9BE00 !important">
                        </div>
                    ...
                    <li class="border-0 nav-item position-relative" role="presentation">
                        <router-link to="employee_CTC" @click="activetab = 2" class=" text-center px-4  border-0 font-['poppins'] text-[14px] text-[#001820]" :class="[activetab === 2 ? 'active font-semibold ' : 'font-medium !text-[#8B8B8B]']">Employee CTC </router-link>
                ...
                <ul class="flex justify-between col-8 flex-wrap max-[1024px]:w-[100%]">
