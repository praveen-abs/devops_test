<template>
    ...
    <div>
        <p class="font-semibold text-lg">Attendance Overtime Reports</p>
    </div>
    ...
    <div class="bg-white p-2 my-2 rounded-lg grid grid-cols-12">
        <div class="grid grid-cols-12 gap-6 col-span-6">
            ...
            <div class=" d-flex justify-content-center align-items-end col-span-4 ">
                <button @click="getAttendanceOvertimeReports" class="btn btn-orange">Generate</button>
        ...
        <div class="col-span-6 flex justify-end gap-4">
            ...
            <button><img src="../../../../assests/download.svg" alt="" srcset="" @click="downloadAttendanceOvertimeReports"
                    class="w-9 h-9 p-2 bg-gray-50 rounded-lg"></button>
...
const downloadAttendanceOvertimeReports = () => {
    let url = '/report/download-over-time-report'
    canShowLoading.value = true
    axios.post(url, {
        start_date: variable.start_date,
        end_date: variable.end_date,
...
const getAttendanceOvertimeReports = () => {
    let url = '/fetch-overtime-report-data'
    canShowLoading.value = true
    axios.post(url, {
        start_date: variable.start_date,
        end_date: variable.end_date,
