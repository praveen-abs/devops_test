<template>
    ...
    <div class="min-h-screen bg-gray-100 text-gray-900 flex  justify-between w-[100%] ">
        <div class="sm:rounded-lg flex justify-between flex-1 !w-[100%] ">
            ...
            <div class="lg:w-1/2 xl:w-5/12  sm:p-12  w-[100%] float-right h-[100vh]">
                <div class=" w-100 d-flex justify-content-center  flex-col align-items-center ">
                    ...
                    <div
                        ...
                        <h1 class="text-[18px] font-medium float-left font-['Poppins']">Login to run your business together</h1>
                        <div class="w-full mt-[20px]">
                            ...
                            <div class="w-full mt-[24px]">
                                ...
                                <div class="w-full">
                                    <p class="w-[140px] hover:text-blue-500 text-[14px] text-color[#535353] float-right font-['Poppins']  font-medium ">Forgot Password ?</p>
                                </div>
                             
                            </div>

                            <button class=" mt-[12px] h-[40px] rounded-[20px] w-full text-[16px] font-['Poppins']" style="background-color: #001820;color:#CCCCCC;">
                                Login
                            </button>

                            <div class="row mt-2">
                                <div class="col h-0  border-b-[1px] border-[#CCCCCC] mt-1"></div>
                                <div class="col-1 text-[14px] font-['Poppins'] text-[#CCCCCC]">Or</div>
                                <div class="col h-0  border-b-[1px] border-[#CCCCCC] mt-1"></div>
                            </div>
                            ...
                            <div class=" d-flex justify-content-center align-items-center flex-col mt-[30px] ">
                                <div class=" d-flex align-items-center flex-col ">
                                    <p class="text-[10.89px]  font-['Poppins'] font-semibold text-[#8B8B8B] text-center">Available for</p>
                                    <h1 class="text-[21.78px]  font-['Poppins'] font-semibold  text-[#8B8B8B]">Download</h1>
                                </div>
