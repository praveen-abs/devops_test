<template>
    ...
    <div class="w-full m-auto">
      ...
      >
      <a class="flex font-semibold fs-6" @click="activetab = 2" :class="[activetab === 2 ? 'active' : '']"
        ><div>2</div>PF & ESI Setting</a
      >
      <a class="flex font-semibold fs-6" @click="activetab = 3" :class="[activetab === 3 ? 'active' : '']"
        ><div>3</div>Salary Components</a
      >
      <a class="flex font-semibold fs-6" @click="activetab = 4" :class="[activetab === 4 ? 'active' : '']"
        ><div>4</div>Salary Structure</a
      >
      <a class="flex font-semibold fs-6" @click="activetab = 5" :class="[activetab === 5 ? 'active' : '']"
        ><div>5</div>Finance Setting
      </a>
      <a class="flex font-semibold fs-6" @click="activetab = 6" :class="[activetab === 6 ? 'active' : '']"><div>6</div>
        Statutory Filling</a
      >
    </div> -->
    ...
    <Dialog header="Header" v-model:visible="usePayroll.canShowLoading" :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
