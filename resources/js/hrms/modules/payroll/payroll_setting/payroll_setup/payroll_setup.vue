<template>
  ...
  <div class="w-full m-auto">
    ...
    <div class="mt-3 tabs w-full  grid grid-cols-6">
      <a class="d-flex font-semibold fs-6  justify-content-content align-items-center max-[1280px]:flex-col " @click="activetab = 1" :class="[activetab === 1 ? 'active' : '']"
        ><div class="md:text-sm">1</div> <p style="" class="max-[1280px]:text-[12px] max-[1280px]:text-center">General payroll Setting</p></a
      >
      <a class="d-flex font-semibold fs-6  justify-content-content align-items-center max-[1280px]:flex-col " @click="activetab = 2" :class="[activetab === 2 ? 'active' : '']"
        ><div>2</div><p class="max-[1280px]:text-[12px] max-[1280px]:text-center"> PF & ESI Setting</p></a
      >
      <a class="d-flex font-semibold fs-6  justify-content-content align-items-center max-[1280px]:flex-col" @click="activetab = 3" :class="[activetab === 3 ? 'active' : '']"
        ><div>3</div><p class="max-[1280px]:text-[12px] max-[1280px]:text-center">Salary Components</p></a
      >
      <a class="d-flex font-semibold fs-6  justify-content-content align-items-center max-[1280px]:flex-col" @click="activetab = 4" :class="[activetab === 4 ? 'active' : '']"
