<template>
    <div class="border-0 card w-100 box-shadow-md">
        <div class="card-body">
            <div class="row">
                <div
                    class="col-8 col-sm-8 col-md-8 col-xl-8 col-lg-8 col-xxl-8"
                >
                    ...
                    <div class="my-3">
                        <i
                            class="fa fa-sun-o me-3 text-warning"
                            aria-hidden="true"
                        ></i
                        >General Shift
                ...
                <div
                    class="col-4 col-sm-4 col-md-4 col-xl-4 col-lg-4 col-xxl-4"
                >
                    <img
                        src="../../dashboard/girl_walk.jpg"
                        class=""
                        alt="girl-walk"
...
onMounted(async () => {
    await mainDashboardStore.getMainDashboardData();
    getSession();
