                                ...
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <input style="height: 20px;width: 20px;" class="form-check-input" type="radio"
                                            name="leave" id="" value="full_day" v-model="service.leave_data.full_day"
                                            @click="full_day">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input style="height: 20px;width: 20px;" class="form-check-input" type="radio"
                                            name="leave" id="" value="half_day" v-model="service.leave_data.half_day"
                                            @click="service.half_day">
                                        <label class="form-check-label leave_type ms-3" for="">Half Day</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input style="height: 20px;width: 20px;" class="form-check-input" type="radio"
                                            name="leave" id="" value="custom" v-model="service.leave_data.custom"
...
import { Service } from "./employee_reimbursements_service";
