<template>
    <div>
        ...
        <div class="px-5 row d-flex justify-content-start align-items-center card-body">
            <div class="flex justify-between gap-6 my-2">
                <div class=" fs-4">
                    <p class="text-xl font-medium text-justify">Five Team members are eligible for the Interest Free Loan as per the
                ...
                <div class="float-right border">
                    ...
                    <Dialog v-model:visible="dialog_NewInterestFreeLoanRequest" header="Header" :style="{ width: '58vw' }" modal :position="position" >
                        <template #header>
    ...
    <Dialog header="Header" v-model:visible="canShowLoading" :breakpoints="{ '960px': '75vw', '640px': '90vw' }" :style="{ width: '25vw' }"
