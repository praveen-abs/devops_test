<template>
    <div class="p-2 overflow-hidden bg-white rounded-lg border" style="height: 200px;">
        <span class="font-semibold text-[14px] text-[#000] font-['Poppins]">Exception Analytics</span>
        <div class="h-full overflow-x-scroll bg-white rounded-lg">
            <div class="px-auto" v-for="request in 3" >
                <div
                    ...
                    <div class="flex px-2 justify-between items-center">
                        <div>
                            <span class="text-[14px] font-semibold">{{request}}</span>
                        </div>
                        <div class="flex items-center gap-6">
                            <span class="text-xl font-semibold text-black">{{request}}</span>
                            <span>
