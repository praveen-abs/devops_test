<template>
    ...
    <Sidebar v-model:visible="useDashboard.canShowShiftDetails" position="right" class="w-full">
        ...
        <div class="mt-6" v-if=" Object.values(useDashboard.currentlySelectedShiftDetails).length >= 1">
    ...
    <Sidebar v-model:visible="useDashboard.canShowAttendanceOverview" position="right" class="w-full">
        ...
        <div class="mt-6" v-if=" Object.values(useDashboard.currentlySelectedShiftDetails).length >= 1">
            <DataTable scrollable scrollHeight="450px"
                :value="useDashboard.currentlySelectedShiftDetails ? useDashboard.currentlySelectedShiftDetails : []">
                <Column field="user_code" header="Employee code" style="white-space: nowrap;"></Column>
                <Column field="name" header="Employee Name" style="white-space: nowrap;"></Column>
                <Column field="department_name" header="Department" style="white-space: nowrap;"></Column>
