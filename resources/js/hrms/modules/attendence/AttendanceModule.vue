                            ...
                            <div class="row ">
                                <div class=" col-sm-3 col-md-3 col-xl-3 col-lg-3 col-xxl-3">
                                    <p class="text-muted fw-normal f-18"><i class="fa fa-calendar me-2" id="calendarIcon"
                                            aria-hidden="true"></i>
                                        <span class="dates " >{{dayjs(new Date()).format('MMMM DD,YYYY')}}</span>
                                    </p>
                                </div>
                                    ...
                                    <ul class="divide-x nav nav-pills divide-solid nav-tabs-dashed" id="pills-tab" role="tablist">
                                        <li class="mx-4 nav-item ember-view" role="presentation">
                                            <a class="nav-link active ember-view " id="pills-home-tab" data-bs-toggle="pill" href=""
                                                data-bs-target="#timesheet" role="tab" aria-controls="pills-home" aria-selected="true">
                                                Timesheet</a>
                                        </li>
                                        <li class=" nav-item ember-view" role="presentation">
                                            <a class="mx-2 nav-link ember-view" id="pills-home-tab" data-bs-toggle="pill" href=""
                                                data-bs-target="#team" role="tab" aria-controls="pills-home" aria-selected="true">
                                                Team Timesheet</a>
                                        </li>
                                        <li class=" nav-item ember-view" role="presentation">
                                            <a class="mx-2 nav-link ember-view" id="pills-home-tab" data-bs-toggle="pill" href=""
                                                data-bs-target="#org" role="tab" aria-controls="pills-home" aria-selected="true">
                                                 Org TImesheet</a>
                                        </li>
