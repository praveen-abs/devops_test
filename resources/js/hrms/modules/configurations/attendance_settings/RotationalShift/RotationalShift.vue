<template>
    <div class="w-full">
      <div>
        ...
        <button class="float-right mx-4 my-3 cursor-pointer btn btn-orange" @click="canShowRotationalShift = true">
        ...
        <Dialog  v-model:visible="canShowRotationalShift" :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
          ...
          <div class="my-3 row">
            <div class="col-5">
                ...
                <div class="flex mt-2">
                    <input type="checkbox" name="" id=""> <p class="mx-2 my-2 text-lg font-semibold" > General Shift</p>
                </div>
                <div class="flex my-1">
                    <input type="checkbox" name="" id=""> <p class="mx-2 my-2 text-lg font-semibold" > Night Shift</p>
                </div>
                <div class="flex">
                    <input type="checkbox" name="" id=""> <p class="mx-2 my-2 text-lg font-semibold" > Other Shift</p>
                </div>
            </div>
            <!-- <div class="col-4">
                <InputText type="text" v-model="txt_shift_name" placeholder="Enter the shift name" />
