<template>
  <div class="w-full">
    <div class="flex justify-between">
      <div></div>
      <div> <button class="float-right mx-4 my-3 cursor-pointer btn btn-orange" @click="canShowRotationalShift = true">
    ...
    <div>
      ...
      <Dialog v-model:visible="canShowRotationalShift" :breakpoints="{ '960px': '75vw', '640px': '90vw' }"
        :style="{ width: '50vw', borderTop: '5px solid #002f56' }" :modal="true" :closable="true" :closeOnEscape="false">
        <template #header>
          <h6 class=" modal-title fs-21">
            Add Rotational Shift</h6>
        </template>
        <div class="my-3 row">
          <div class="col-5">
          ...
          <div class="col-4">
            <InputText type="text" v-model="txt_shift_name" placeholder="Enter the shift name" class="w-full" />
          </div>
        </div>
        <div class="my-3 row">
          <div class="col-5">
            <p class="text-lg font-semibold">Choose the rotation option</p>
          </div>
          <div class="col-4">
            <Dropdown editable optionLabel="name" optionValue="name" placeholder="Choose Rotational Shift "  class="w-full p-error" />
          </div>
        </div>
        <div class="my-3 row">
          <div class="col-5">
            <p class="text-lg font-semibold">Select the shifts to be rotated</p>
            <div class="flex mt-2">
              <input type="checkbox" name="" id="">
              <p class="mx-2 my-2 text-lg font-semibold"> General Shift</p>
            </div>
            <div class="flex my-1">
              <input type="checkbox" name="" id="">
              <p class="mx-2 my-2 text-lg font-semibold"> Night Shift</p>
            </div>
            <div class="flex">
              <input type="checkbox" name="" id="">
              <p class="mx-2 my-2 text-lg font-semibold"> Other Shift</p>
            </div>
          </div>
          <!-- <div class="col-4">
