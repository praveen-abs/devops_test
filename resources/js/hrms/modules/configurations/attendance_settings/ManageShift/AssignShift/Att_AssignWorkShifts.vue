  ...
  <div class="w-full ">
    ...
    <div class="flex px-4 pt-6 gap-9">
      ...
      <div>
        ...
        <span class="mx-2">
          <InputText type="text" v-model="useAttendanceStore.shiftDetails.txt_shift_name" placeholder="Enter the shift name" />
        </span>
      </div>
      <div>
        <span class="text-lg font-semibold">Shift Code</span>
        <span class="mx-2">
          <InputText type="text" v-model="useAttendanceStore.shiftDetails.Shift_Code" placeholder="Enter the shift code" />
        </span>
      </div>
      <div class="flex my-2">
    ...
    <div class="mx-4">
      ...
      <DataTable :value="useAttendanceStore.array_shiftDetails" v-model:selection="useAttendanceStore.selectedEmployees" :paginator="true" :rows="2"
