      ...
      <div class="col-sm-12 col-xl-12 col-md-12 col-lg-12 ">
          <div class="mb-0 card leave-history">
              <div class="card-body">
                  ...
                  <div>
                      <DataTable :value="leave_data" :rows="5" :rowsPerPageOptions="[5, 10, 25]" :paginator="true"
                          responsiveLayout="scroll"
                          currentPageReportTemplate="Showing {first} to {last} of {totalRecords}"
                          paginatorTemplate="CurrentPageReport FirstPageLink PrevPageLink PageLinks NextPageLink LastPageLink RowsPerPageDropdown"
                          v-model:filters="filters" filterDisplay="menu" :globalFilterFields="['name', 'status']">
                          <Column field="employee_name" header="Employee Name" style="min-width: 15rem;">
                          ...
                          <Column v-for="leave_type of leave_types" :key="leave_type.id" :header="leave_type"
