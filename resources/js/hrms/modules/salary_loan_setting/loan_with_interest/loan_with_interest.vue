      ...
      <div v-else class="row">
        ...
        <div>
          ...
          <div class="col-10 ">
            ...
            <p class="my-2 fs-5 ">The employees not eligible for Interest Free Loan can also claim the Loan with Interest
            </p>
              ...
              <div class="rounded-lg shadow-sm card border-L ">
                <div class="card-body ">
                  <div class="row">
                    ...
                    <div class="col-10">
                      <p class="fs-6 clr-gray ">(Note: This will be calculated based on the employee's date of joining.)
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card border-L">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-12">
                      <p class="fs-6 clr-gray">(Note: Please ensure that the percentage entered for the loan interest rate
            ...
            <div class="col">
              ...
              <p class="my-2 fs-5">The EMI, or Equated Monthly Installment, is the sum of the principal amount borrowed
                  ...
                  <div class="card-body">
                    ...
                    <div class="my-1 row">
                      <div class="col-7 d-flex justify-content-start align-items-center">
                        <RadioButton v-model="salaryStore.lwif.deductMethod" inputId="ingredient1" name="percofsaladvance"
                          value="emi" />
                        <label for="" class="mx-3 fs-5 clr-dark">Employee can select the month when they would like their
                          EMI
                          payments to begin
                        </label>
                      </div>
