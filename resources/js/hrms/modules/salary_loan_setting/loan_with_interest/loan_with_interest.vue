          ...
          <div class="col-10 ">
            ...
            <div class="card rounded-lg shadow-sm  border-L ">
              <div class="card-body ">
                <div class="row">
                    <div class="col-12 ">
                        <h1 class="fs-5">Enter the maximum eligible amount of loan can be availed by the employees <InputText type="text" v-model="value" style="width: 150px;" /></h1>
                    </div>
                    <div class="col-10">
            ...
            <div class="col-12">
                ...
                <div class="card border-L">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="fs-5">Enter the percentage of interest for the loan    <InputText type="text" v-model="value" style="width: 150px;" /> of the loan amount. </h1>
                            </div>
                            <div class="col-12">
                                <p class="fs-6 clr-gray">(Note: Please ensure that the percentage entered for the loan interest rate is not higher than the current SBI lending rate.)</p>
                            </div>
                        </div>
                    </div>
                </div>
