<template>
    ...
    <div class="card-body">
      <div class="row">
        <div class="col-12 text-end">
          <button
            class="p-0 m-0 bg-transparent border-0 outline-none btn"
            data-bs-target="#show_idCard"
        ...
        <div class="text-center col-12">
          <div class="mx-auto rounded-circle img-xl userActive-status profile-img">
            ...
            <label
              ...
              data-bs-toggle="modal"
              data-bs-target="#edit_profileImg"
              id=""
              for="upload"
            >
          ...
          <div class="mt-4">
            <div class="progress-wrapper border-bottom-liteAsh">
              ...
              <div class="mx-auto mb-1 d-flex justify-content-between">
                ...
                <span
                  class="text-muted text-end f-12 fw-bold"
                  id="prograssBar_percentage"
                >
                </span>
              </div>
            ...
            <div class="mb-4 text-center profile-mid-right-content">
              <div class="py-2 border-bottom-liteAsh">
                ...
                <p
                  v-if="_instance_profilePagesStore.employeeDetails.active == 1"
                  class="f-15 fw-bold"
                >
                  Active
                </p>
              ...
              <div class="py-2 border-bottom-liteAsh">
                ...
                <p
                  v-if="_instance_profilePagesStore.employeeDetails.user_code"
                  class="f-15 fw-bold"
                >
              ...
              <div class="py-2 border-bottom-liteAsh">
                <p class="text-muted f-12 fw-bold">
                  Department
                  <a href="#" class="edit-icon" @click="dailogDepartment = true"
  ...
  <Dialog
    v-model:visible="dailogDepartment"
    modal
  ...
  >
    ...
    <Dropdown
      ...
      optionLabel="name"
      v-model="employee_card.department"
  ...
  <Dialog
    v-model:visible="dailogReporting"
    modal
  ...
  >
    <Dropdown
      ...
      v-model="employee_card.reporting_manager"
      optionValue="id"
