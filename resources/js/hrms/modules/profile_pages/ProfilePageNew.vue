...
<template>
    ...
    <LoadingSpinner v-if="_instance_profilePagesStore.loading_screen" />
    ...
    <!-- <div class="profile_page-wrapper  container-fluid">
        <div class="row">
            <div v-if="!_instance_profilePagesStore.loading_screen"> <EmployeeCard /></div> -->
    <!--<div v-if="!_instance_profilePagesStore.loading_screen"
                class="col-3 col-sm-12 col-md-3 col-lg-3 col-xxl-3 col-xl-3">
                <EmployeeCard />
            </div>
