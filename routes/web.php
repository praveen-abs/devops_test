...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/reports/half-dayabsent-attendance-report', [App\Http\Controllers\VmtEmployeeAttendanceController::class, 'showHalfdayAbsentReport'])->name('showAbsentReport');
