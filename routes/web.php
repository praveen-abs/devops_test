...
//Pay Check module
    ...
    Route::get('/pdfview/{emp_code?}/{selectedPaySliMonth?}',[App\Http\Controllers\VmtPayCheckController::class, 'getEmployeePayslipDetailsAsPDF_v2'])->name('getEmployeePayslipDetailsAsPDF_v2');
