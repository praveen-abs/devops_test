...
Route::middleware(['auth'])->group(function () {
   ...
   //Pms Form download
    ...
    Route::post('/getAssignedPMSFormTemplates', [App\Http\Controllers\PMS\VmtPMSFormsMgmtController::class, 'getAssignedPMSFormTemplates'])->name('getAssignedPMSFormTemplates');
