...
Route::middleware(['auth', 'EnsureDefaultPasswordUpdated'])->group(function () {
   ...
   // Route::get('/upcoming-employee-leaves', [App\Http\Controllers\VmtAttendanceController::class, 'getEmployeeUpcomingAppliedRequested'])->name('getEmployeeUpcomingAppliedRequested');
    ...
    //Attendance - AJAX
    Route::post('/fetch-attendance-user-timesheet', [App\Http\Controllers\VmtAttendanceController::class, 'fetchUserTimesheet'])->name('fetch-attendance-user-timesheet');
    ...
    ///basic report
    Route::get('/fetch-employee-master-report', [App\Http\Controllers\VmtReportsController::class, 'getEmployeesMasterCTCData'])->name('getEmployeesMasterCTCData');
    //for master detail
    ...
    //employeectcreports
    Route::post('/fetch_employee_ctc_report', [App\Http\Controllers\VmtReportsController::class, 'getEmployeesCTCDetails'])->name('getEmployeesCTCDetails');
    ...
    Route::post('/getClientMobilePermissionsDetails', [App\Http\Controllers\VmtMasterConfigController::class, 'getClientMobilePermissionsDetails'])->name('getClientMobilePermissionsDetails');
