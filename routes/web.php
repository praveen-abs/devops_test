...
Route::middleware(['auth', 'EnsureDefaultPasswordUpdated'])->group(function () {
    ...
    Route::post('/get-attendance-dashboard', [App\Http\Controllers\VmtAttendanceController::class, 'getAttendanceDashboardData'])->name('getAttendanceDashboardData');
    ...
    //Attendance - AJAX
    Route::post('/fetch-attendance-user-timesheet', [App\Http\Controllers\VmtAttendanceController::class, 'fetchAttendanceDailyReport_PerMonth_v2'])->name('fetchAttendanceDailyReport_PerMonth_v2');
